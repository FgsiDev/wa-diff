__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function c(e, t) {
      var n, r;
      return (n = (r = s(e, t)) == null ? void 0 : r.posts) != null ? n : [];
    }
    function d(e, t, n) {
      return c(e, t).find(function (e) {
        return (
          o(
            "AdsUEditorAdgroupMultiPostSpecUtils",
    ...
    function m(e, t, n, r) {
      if (d(e, t, n) == null) return e;
      var a = c(e, t).map(function (e) {
        return o(
          "AdsUEditorAdgroupMultiPostSpecUtils",
        ).getPostIdentityKeyFromCagPost(e) === n
    ...
    function _(e, t) {
      ...
      if (n.length > 0)
        return o(
          "AdsUEditorAdgroupMultiPostSpecUtils",
        ).getMultiPostCustomizationsFromCagSpec(n);
      var a = new Map();
      if (t) return a;
      var i = p(e);
      if (i == null) return a;
      var l = r("AdsAdgroupRecordAccessors").creative.call_to_action.get(e),
        s = l == null ? void 0 : l.value;
      return (
        a.set(i, {
          body: r("AdsAdgroupRecordAccessors").creative.body.get(e),
          call_to_action:
            l == null
              ? void 0
              : {
                  type: l.type,
                  value: {
                    app_destination: s == null ? void 0 : s.app_destination,
                    app_link: s == null ? void 0 : s.app_link,
                    link: s == null ? void 0 : s.link,
                    link_caption: s == null ? void 0 : s.link_caption,
                  },
                },
          title: r(
            "AdsAdgroupRecordAccessors",
          ).creative.existing_post_title.get(e),
        }),
        a
      );
    }
    ...
    function S(e, t, n, r, o) {
      ...
      switch (r) {
        case "primary_text":
          N(n, d) && (d.splice(n, 1), (m = !0));
          break;
        case "headline":
          N(n, c) && (c.splice(n, 1), (m = !0));
          break;
        case "description":
          N(n, l) && (l.splice(n, 1), (m = !0));
          break;
      }
      var p = d.concat(c).concat(l),
        _ = u(e, t, p, "texts");
      return (t === 0 && m && (_ = M(_, o)), _);
    }
      ...
      var o,
        a =
          (o = e.creative_asset_groups_spec) == null || (o = o.toJS()) == null
            ...
            : o.groups;
      if (a == null) return e;
      for (var i = e, l = 0; l < a.length; l++) i = I(i, l, t, n, r);
      return i;
    }
    function D(e, t) {
      var n,
    ...
    function M(e, t) {
      ...
      if (u.length <= 1 && l.length <= 1 && i.length <= 1) {
        ...
        c = V(c, _);
        var f = W(e);
        if ((r("isTruthy")(m) && (c = H(c, e)), u.length > 0)) {
          var g,
            h = (g = u[0].text) != null ? g : "";
          c = f
            ? r(
    ...
    function w(e, t, n, a, i, l) {
      ...
      var x = r("AdsAdgroupRecordAccessors").creative.call_to_action_type.get(
        ...
        q = o(
          "AdsUEditorCTXFlexibleFormatUtils",
        ).isClickToMessageAppDestination(w)
        ...
        K = j
          ...
          : (S =
            ...
            : a,
        Q = j
          ? (E = (k = F != null ? F : O) != null ? k : B) != null
            ? E
            : i
          : (I = (T = F != null ? F : B) != null ? T : O) != null
            ? I
            : i,
        X = j || !z,
        Y = e;
    ...
    function j(e, t) {
      var n,
        ...
        m = o("AdsMutators").chain.apply(
          ...
          [
            ...
            G(t, "standard_enhancements", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
            ...
            G(t, "image_enhancement", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
            ...
            G(t, "image_templates", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
            ...
            G(t, "advantage_plus_creative", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
            ...
            G(t, "text_optimizations", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
            ...
            G(t, "product_extensions", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
            ...
            G(t, "site_extensions", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
            ...
            o("AdsAPlusCSCJUtils").passNativeCommerceExperienceNonCTAGK() &&
              ...
              ? G(t, "product_browsing", function (e) {
                  return [
                    r(
                      "AdsAdgroupRecordAccessors",
      ...
      return (
        r("gkx")("3442") &&
          t &&
          (d == null ? void 0 : d.enroll_status) === "OPT_IN" &&
          (p == null ? void 0 : p.enroll_status) !== "OPT_IN" &&
          (m = r(
            "AdsAdgroupRecordAccessors",
      ...
      var n,
        ...
        m = o("AdsMutators").chain.apply(
          ...
          [
            ...
            G(t, "video_auto_crop", function (e) {
              return [
                r(
                  "AdsAdgroupRecordAccessors",
    ...
    function Q(e, t, n, a, i, l, s) {
      ...
      return r("isTruthy")(l) && r("gkx")("1226") ? F(n, l) : p;
    }
    function X(e, t, n, a, i) {
      ...
      return r("isTruthy")(i) && r("gkx")("1226") ? F(e, i) : b;
    }
    function Y(e, t, n, a) {
      var i,
        l = (i = r(
      ...
      return r("isTruthy")(a) && r("gkx")("1226") ? F(c, a) : c;
    }
    function J(e, t, n) {
      var a,
        i,
      ...
      var t,
        n =
          (t = e.creative_asset_groups_spec) == null || (t = t.toJS()) == null
            ...
            : t.groups;
      if (n == null) return e;
      for (var r = e, o = 0; o < n.length; o++) r = Z(r, o);
      return r;
    }
    function te(e) {
      if (e == null) return !1;
    ...
    ((l.getCagGroupAtIndex = s),
      ...
      (l.getCagPostsAtIndex = c),
      (l.getCagPostByIdentity = d),
      (l.setCagPostFieldsByIdentityKey = m),
      (l.getPrimaryPostIdentity = p),
      (l.getCustomizationsForSelectedPosts = _),
      (l.deleteSpecsInCagGroup = f),
      (l.clearCagGroups = g),
      (l.setNewGroupSpec = h),
      (l.setNewGroupSpecAtStart = y),
      (l.setTextSpecWithTypeAtIndex = C),
      (l.setGroupTypeforCagGroup = b),
      (l.removeImagesFromCagGroup = v),
      (l.removeTextSpecWithTypeAtIndex = S),
      (l.setImageCropAtIndex = R),
      (l.setVideoThumbnailInfoAtIndex = L),
      (l.setVideoAtIndex = E),
      (l.removeSpecAtIndex = k),
      (l.setCagCallToActionValueByValueType = I),
      (l.setCagCallToActionValueByValueTypeForAllGroups = T),
      (l.setCagCallToActionType = D),
      (l.setCagMessageExtension = x),
      (l.setDefaultCagCallToActionTypeAtIndex = $),
      (l.updateMediaSpecToCreativeSpec = F),
      (l.updateFormatSpecBasedOnCreativeSpec = O),
      (l.setDOFToggleSpecForCag = q),
      (l.maybeRemoveCagSpec = U),
      (l.setDefaultCreativeSettingForASCAndBAU = Q),
      (l.setDefaultCreativeSettingForCTX = X),
      (l.setDefaultCreativeSettingForAppPromotion = Y),
      (l.cleanupCreativeDoubleWrittenFields = J),
      (l.cleanUpCagCallToActionValue = Z),
      (l.cleanUpCagCallToActionValueForAllGroups = ee),
      (l.doesCagHaveGroupUuid = te));
  },
  98,
);
