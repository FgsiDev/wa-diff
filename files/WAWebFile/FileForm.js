    ...
    var u = (function (t) {
      function n(e, n, a) {
        ...
        if (
          ...
          (i._click = function (e) {
            for (var t = e.getTarget(); t != null && r("isElementNode")(t); ) {
              if (t.type === "submit") {
      ...
      return (
        ...
        (a._getStatusElement = function () {
          var e = o("Parent").byClass(this._form, "stat_elem");
          return e instanceof HTMLElement ? e : this._form;
        }),
