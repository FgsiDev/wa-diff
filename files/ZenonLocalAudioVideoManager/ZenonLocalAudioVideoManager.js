                  ...
                  if (
                    (n.name === "NotReadableError"
                      ...
                      : n.name === "OverconstrainedError" &&
                        ((a = t.requestVideo && Object.keys(t).length > 1),
                        (i = e.requestAudio && Object.keys(e).length > 1)),
                    a &&
                      this.$ZenonLocalAudioVideoManager$p_14(
                    ...
                    return this.$ZenonLocalAudioVideoManager$p_9(
                      i ? { requestAudio: e.requestAudio } : e,
                      a ? { requestVideo: t.requestVideo } : t,
                    );
                  throw l != null
                    ? l
                    : r("err")(
