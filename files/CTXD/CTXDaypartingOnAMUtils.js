__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    function M(e, t, n) {
      return e !== "daily" ? !1 : t != null && n != null ? P(t, n) : !0;
    }
    function w(e, t, n) {
    ...
    function U(e, t, n, a, i, l, s) {
      ...
      if (p == null) return !1;
      if (
        (B([].concat(e), r("AdsUEditorHostIDs").EDITING, p, ["day_parting"]),
        l == null)
      )
        return !0;
      for (var _ of l)
    ...
    function Y(e) {
      var t = o("react-compiler-runtime").c(19),
        ...
        i = e.scheduleTier,
        l;
      t[0] !== a ? ((l = G(a)), (t[0] = a), (t[1] = l)) : (l = t[1]);
      var u = l,
        c;
      t[2] !== n || t[3] !== a || t[4] !== i
        ? ((c = z(i, a, n)), (t[2] = n), (t[3] = a), (t[4] = i), (t[5] = c))
        : (c = t[5]);
      var d = c,
        m;
      t[6] !== i
    ...
    ((l.PresetSchedule = f),
      ...
      (l.getCTXPresetScheduleOptions = I),
      (l.getDefaultScheduleTier = T),
      (l.getCTXScheduleForPreset = D),
      (l.getScheduleForPreset = x),
      (l.isInCTXDaypartingOnAMQE = $),
      (l.isEligibleForCTXDaypartingOnAM = P),
      (l.shouldShowCTXDaypartingPFR = N),
      (l.isEligibleForCampaignSchedulingDailyBudget = M),
      (l.getEffectiveBudgetMode = w),
      (l.FULL_DAY_SCHEDULE = A),
      (l.matchPresetFromSchedule = F),
      (l.isFullDaySchedule = O),
      (l.dispatchCampaignScheduleChange = B),
      (l.dispatchCampaignGroupToggleDayParting = W),
      (l.setCTXDefaultScheduleForDailyBudget = q),
      (l.applyCTXBusinessHourAdScheduleForDailyBudget = U),
      (l.getScheduleTier = V),
      (l.getScheduleTierForPreset = H),
      (l.isScheduleTrimmingEnabled = j),
      (l.getCampaignDateRangeDays = K),
      (l.trimScheduleToCampaignDays = Q),
      (l.filterPresetOptionsByCampaignDays = X),
      (l.CTXDaypartingInfoBanner = Y));
  },
  226,
);
