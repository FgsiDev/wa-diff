  ...
  function (t, n, r, o, a, i, l) {
    ...
    function e(e, t, n, a, i, l) {
      ...
      function u(t, n, a, u, c, d, m, p) {
        var _ = t.metadata.is_ls_relay_request === !0,
          f = t.metadata.operation;
        if (!_ && f == null) return e.execute.apply(null, arguments);
        var g = { kind: "Request", operation: r("nullthrows")(f), params: t };
        return o("relay-runtime").Observable.create(function (r) {
          var _,
            f = t.id == null && t.text == null;
          if (!f && p != null) {
            var h = p.checkOperation,
              y = p.parentOperation;
            y != null && (f = h(y).status === "available");
          }
          var C =
            i ||
            ((_ = g.operation.use_network_normalization_provider) == null
              ? void 0
              : _.get()) === !0 ||
            g.operation.has_server_to_client_resolvers === !0 ||
            g.operation.has_client_to_server_resolvers === !0;
          if (f && !C) {
            var b = o("relay-runtime").__internal.getOperationVariables(
              ...
              v = s
                .execute(o("relay-runtime").createRequestDescriptor(g, b))
                .subscribe({
                  complete: r.complete,
                  error: r.error,
                  next: function (t) {
          ...
          if (C) {
            var L = f
              ...
              E = s
                .executeWithNetwork(
                  o("relay-runtime").createRequestDescriptor(g, R),
                  L,
                  {
          ...
          if (((x = w), D)) return P;
          var A = s
              .execute(o("relay-runtime").createRequestDescriptor(g, R))
              .subscribe({
                complete: T,
                error: N,
                next: function (t) {
