__d(
  "CometModernCommentTextLinkedEntityRenderer",
  [
    "Comet2K2ELink.react",
    "CometDangerouslySuppressInteractiveElementsContext",
    "CometHovercardLinkContext",
    "CometModernCommentTextLinkedEntityRenderer_entity.graphql",
    "CometRelay",
    "FDSLink.react",
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      ...
      c = s.useContext;
    e !== void 0 ||
      (e = n("CometModernCommentTextLinkedEntityRenderer_entity.graphql"));
    function d(e) {
      var t,
      ...
      var h = o("useRenderLinkedEntity").useRenderLinkedEntity(g, s),
        ...
        E;
      if (
        n[6] !== (y == null ? void 0 : y.color_DEPRECATED) ||
        n[7] !== R ||
        n[8] !== a ||
        n[9] !== i ||
        n[10] !== C ||
        ...
        e: {
          ...
          if (a.__typename === "User" || a.__typename === "XFBWorkroomsUser") {
            var w = C != null ? C : null,
              A;
            (n[36] !== a || n[37] !== l || n[38] !== w
              ? ((A = u.jsxs(r("ProfileCometProfileLink.react"), {
                  actor: a,
      ...
      switch (a.__typename) {
        ...
        case "Page": {
          var Y;
          n[57] !== l
            ? ((Y = { children: l }), (n[57] = l), (n[58] = Y))
            : (Y = n[58]);
          var J;
          return (
            n[59] !== a || n[60] !== X || n[61] !== Y
