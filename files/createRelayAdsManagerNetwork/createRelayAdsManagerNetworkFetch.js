          ...
          c().subscribe({
            next: function (f) {
              var c = new (r("RelayAPIRequest"))(t, d, m)
                  ...
                  .setResponseChunkHandler(g),
                h = babelHelpers.extends({}, u, r("getAsyncParams")("POST"), {
              ...
              if (
                ...
                f != null &&
                  f.length > 0 &&
                  (h.fb_api_analytics_tags = JSON.stringify(f)),
                s != null)
              )
                c.setRawData(e(s, h));
              else {
                ...
                c.setData(h).setRequestHeaders(babelHelpers.extends({}, y, a));
              }
              return ((_ = c.send().abort), _);
            },
          }),
          function () {
            !f && _ != null && _();
