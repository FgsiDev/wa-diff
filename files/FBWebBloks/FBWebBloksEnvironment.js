        ...
        t[0] !== e
          ? ((n = function () {
              return o(
                ...
                {
                  actions: o("FBWebBloksPrimitives").ACTIONS,
                  components: o("FbWebWebBloksComponents").COMPONENTS,
                  containerConfigs: o("FBWebBloksPrimitives").CONTAINER_CONFIGS,
                  traversalKeys: r("fbWebTraversalKeys"),
                  versioningID: r("fbWebVersioningId"),
                  ...
                  minificationMap: r("fbWebMinificationMap"),
                  ...
                  enableNoOpVariableWriteFilter:
                    window.wbloks_enable_noop_write_filter === !0,
                  accessibilityModule: {
