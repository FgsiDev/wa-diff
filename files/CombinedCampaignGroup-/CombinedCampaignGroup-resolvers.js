__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function Ce(e) {
      return e.campaignGroup.rf_campaign_type;
    }
    function be(e) {
    ...
    ((l.CombinedCampaignGroup = d),
      ...
      (l.rf_campaign_type = Ce),
      (l.smart_promotion_type = be),
      (l.source_campaign_id = ve),
      (l.source_recommendation_type = Se),
      (l.source_object = Re),
      (l.special_ad_categories = Le),
      (l.special_ad_category = Ee),
      (l.special_ad_category_country = ke),
      (l.spend_cap = Ie),
      (l.start_time = Te),
      (l.status = De),
      (l.stop_time = xe),
      (l.study_ids = $e),
      (l.include_in_ad_study_id = Pe),
      (l.rf_prediction_id = Ne),
      (l.topline_id = Me),
      (l.updated_time = we),
      (l.yesterday_spent = Ae),
      (l.publish_object_DO_NOT_USE = Fe),
      (l.budget_strategy = Oe),
      (l.time_suggestion = Be),
      (l.utils = We),
      (l.is_full_funnel = qe),
      (l.automation_unified_campaign_type = Ue),
      (l.include_in_ad_study_cell_id = Ve));
  },
  98,
);
