__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function C(e, t, n) {
      y.onReady(function (r) {
        r.logMAIBAWorkspaceCanvasFailure(e, t, n);
      });
    }
    var b = {
        canNavigateBack: !1,
    ...
    function L(e, t, n, r, a, i, l, s, u, c, d, m, p, _, f, g) {
      if ((g === void 0 && (g = !1), i.current === n)) {
        var h = e.workspace_type;
        if (h == null || h === "") {
          C(n, e, "missing_workspace_type");
          return;
        }
        var y = r.current,
          b = o("useMAIBAWorkspaceInlineEntryPointCache").entryPointKey(e),
          v = !g && l.current === n ? s.current : null;
        if (
          v != null &&
        ...
        if (
          v != null &&
          o("MAIBAWorkspaceExperienceRegistry").getWorkspaceExperiencePolicy(h)
            .inlineRefresh &&
          o("useMAIBAWorkspaceInlineEntryPointCache").entryPointInstanceKey(
            v.entity,
          ) ===
            o("useMAIBAWorkspaceInlineEntryPointCache").entryPointInstanceKey(e)
        ) {
          ((s.current = { entity: e, loaded: v.loaded }), p(e, v.loaded));
          return;
        }
        var R = o(
            "useMAIBAWorkspaceInlineEntryPointCache",
          ).entryPointInstanceKey(e),
          L = !g && u.current === n ? c.current.get(R) : null,
          E = a.current.get(R);
        if (
          L != null &&
          (E === b ||
        ...
        (o("MAIBAObservabilityUtils").addMAIBAWorkspaceLoadMarkerPoint(
          ...
          o("MAIBAWorkspaceExperienceRegistry")
            .loadWorkspaceExperienceAsync(h)
            .catch(function (t) {
              throw (C(n, e, "experience_module_load_rejected"), t);
            })
            .then(function (v) {
              if (v == null) {
                C(n, e, "experience_module_unavailable");
                return;
              }
              if (!(r.current !== y || i.current !== n)) {
                o("MAIBAObservabilityUtils").addMAIBAWorkspaceLoadMarkerPoint(
                ...
                try {
                  ...
                  var E = !g && u.current === n ? c.current.get(R) : null,
                    k = u.current === n ? a.current.get(R) : null;
                  if (
                    E != null &&
                    (k === b ||
                      o(
                        "MAIBAWorkspaceExperienceRegistry",
                      ).getWorkspaceExperiencePolicy(h).inlineRefresh)
                  ) {
                    var I =
                      L != null &&
                      o(
                        "useMAIBAWorkspaceInlineEntryPointCache",
                      ).entryPointInstanceKey(L.entity) === R &&
                      L.loaded !== E
                        ? [L.loaded]
                        : [];
                    ((s.current = { entity: e, loaded: E }),
                      (l.current = n),
                      p(e, E),
                      _(E),
                      f(n),
                  ...
                  var T = u.current === n ? c.current.get(R) : null,
                    D = v.loadExperienceEntryPoint(t, e, n);
                  if (D == null) {
                    C(n, e, "envelope_rejected_by_experience");
                    return;
                  }
                  var x = [];
                  if (L != null && L.loaded !== D) {
                    var $ =
                        o(
                          "useMAIBAWorkspaceInlineEntryPointCache",
                        ).entryPointInstanceKey(L.entity) !== R,
                      P = $ && S(L.loaded);
                    ($ && !P && m(L.entity, L.loaded), P || x.push(L.loaded));
                  }
                  (T != null && T !== D && x.push(T),
                    (s.current = { entity: e, loaded: D }),
                    (l.current = n),
                    p(e, D),
                    _(D),
                    f(n),
                  ...
                  C(n, e, "experience_entry_point_load_threw");
                }
              }
            })
            .catch(function () {}));
    ...
    function k(e) {
        ...
        ? ((xe = function () {
            (a ||
              y.onReady(function (e) {
                e.startMAIBAWorkspaceLoad(r, b.current, "open_canvas");
              }),
              C(x),
        ...
        ? ((Xe = function () {
            (u.current !== r &&
              ...
              R({
                ...
                prevConversationRef: u,
                publishedEntityConversationIDRef: S,
                recordConversationIDRef: O,
                recordRef: F,
      ...
      return (
        t[87] !== n || t[88] !== ot
          ? ((at = s.jsx(v.Provider, { value: ot, children: n })),
            (t[87] = n),
            (t[88] = ot),
            (t[89] = at))
          : (at = t[89]),
    ...
    ((l.MAIBAWorkspaceCanvasProvider = k),
      (l.useMAIBAWorkspaceCanvas = P),
      (l.useIsMAIBAWorkspaceCanvasMounted = N));
  },
  98,
);
