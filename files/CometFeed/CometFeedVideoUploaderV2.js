      ...
      u = (function () {
        ...
        return (
          ...
          (o.$23 = function (n, r) {
            ...
            i.push(l);
            var u = n.subscribe("upload-started", function (t, n) {
              var r = { uploadID: o };
              e.$2.onUploadStarted == null || e.$2.onUploadStarted(r);
            });
            i.push(u);
            var c = n.subscribe("upload-progressed", function (t, n) {
              var r,
                i,
            ...
            i.push(c);
            var d = n.subscribe("upload-finished", function (t, n) {
              var r,
                a = {
            ...
            i.push(d);
            var m = n.subscribe("upload-failed", function (n, r) {
              var a,
                i,
                l,
                u,
                ...
                m = {
                  ...
                  error:
                    (i =
                      (l = d == null ? void 0 : d.description) != null
                        ? l
                        : (u = r.error_description) == null
                          ? void 0
                          : u.toString()) != null
                      ? i
                      : s._(/*BTDS*/ "Video upload failed").toString(),
                  errorClass:
                    (c = d == null ? void 0 : d.errorClass) != null
                      ? c
                      : "shim_error",
                  errorCode: r.error_code,
                  uploadID: o,
                };
              (e.$2.onUploadError == null || e.$2.onUploadError(m),
                e.$6.delete(o),
                e.$24(o),
                e.$7.delete(o),
                e.$20());
            ...
            i.push(m);
            var p = n.subscribe("upload-canceled", function (t, n) {
