__d(
  ...
  function (t, n, r, o, a, i, l) {
            ...
            var V,
              H =
                (V = E.creative) == null || (V = V.object_story_spec) == null
                  ? void 0
                  : V.page_id,
              z = r("isTruthy")(H) && v && v.has(H) ? v.get(H) : null;
            E = h({
              account: k,
              callToActionType: i,
    ...
    ((l.setCallToAction = s),
      ...
      (l.setCallToActionValueInstagramProfileDestination = V),
      (l.deleteCallToActionValueInstagramProfileDestination = H),
      (l.deleteCallToAction = G),
      (l.resetCallToActionValue = z));
  },
  98,
);
