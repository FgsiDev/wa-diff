__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    function L(e) {
      ...
      return (
        r.length > 0 && (t = S(r)),
        o.length > 0 && ((n = R(o)), r.length === 0 && ((t = n), (n = void 0))),
    ...
    ((l.getCropImageSpecsForAdType = f),
      (l.getDisabledCropImageSpecsForAdType = g),
      (l.getUniqueCropImageSpecs = h),
      (l.getLeastStringentImageSpec = y),
      (l.getRecommendedImageSpec = C),
      (l.getFacebookImageSpecs = b),
      (l.getInstagramImageSpecs = v),
      (l.reduceMinImageSpec = L),
      (l.reduceAndMergeImageSpec = E),
      (l.getSelectedInstagramImageSpec = k),
      (l.getAllImageSpecs = I),
      (l.getLabelForImageSpec = T),
      (l.sortSpecs = D),
      (l.getMinSizeForIGAdImages = x));
  },
  98,
);
