__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function _(e, t, n, o, a, l, u) {
      var c = this.pivots.objective;
      return t &&
        ...
        ? s.jsx(r("CometPlaceholder.react"), {
            ...
            children: s.jsx(
              m,
              { errorsByPath: o, offsiteCustomEvent: l },
              "roas_warning",
            ),
          })
        : e === r("AdsAPIOptimizationGoals").OFFSITE_CONVERSIONS
          ? s.jsx(r("CometPlaceholder.react"), {
              ...
              children: s.jsx(
                p,
                { conversionChoice: a, objective: c, optimizationGoal: e },
                "pixel_warning",
              ),
            })
          : null;
        ...
        r("AdsDefaultCampaignOptimizationPlugin"),
        {
            ...
            switch (t) {
              ...
              case r("AdsAPIOptimizationGoals").OFFSITE_CONVERSIONS:
                if (
                  ...
                  var l = f.getClickConversionWindowOptions(
                      r("nullthrows")(t),
                      n,
                      a,
                    ),
                  ...
                  if (s != null)
                    return o(
                      "AdsDeliveryAttributionUtils",
                    ).findNearestWindowDays(s.window_days, l);
                }
                return 7;
              case r("AdsAPIOptimizationGoals").OFFLINE_CONVERSIONS:
                return 7;
          ...
          getDefaultViewConversionWindowLength: function (t, n) {
            ...
            var l = o("AdsDeliveryAttributionUtils").findNearestWindowDays(
              i.window_days,
              f.getViewConversionWindowOptions(r("nullthrows")(t)),
            );
          ...
          getSupportedOptimizationGoals: function (t) {
            var e = t.disableLPVOptimization,
              ...
              s = o(
                "AdsLandingPageViewsUtils",
              ).canSeeOptimizationGoalInDropdown(!!n, i, a);
