__d(
  "AdsDynamicTargetingPackageAddedToCartNotPurchasedPlugin",
  [
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      ...
      c = {
        ...
        key: "ADDED_TO_CART_NOT_PURCHASED",
        ...
        renderCard: function (t) {
          ...
          return s.jsx(r("CometPlaceholder.react"), {
            ...
            children: s.jsx(u, {
              ...
              id: "ADDED_TO_CART_NOT_PURCHASED",
              onChange: l,
            ...
            inclusions: [
              {
                retention_seconds:
                  o("AdsAudienceBehaviorUtils")
                    .DEFAULT_RETENTION_DAYS_ADDED_TO_CART_NOT_PURCHASED *
