__d(
  ...
  function (t, n, r, o, a, i, l) {
      ...
      return (
        ...
        r("promiseDone")((e || (e = n("Promise"))).resolve({}), function () {
          r("AdsUEditorAdgroupWebsiteAddOnDefaultedAction").dispatch(
            ...
            { line: "832", module: "WebToXDefaultingUtils.js", moduleID: i.id },
          );
        }),
    ...
    function S(e, t, n, a, i, l, s, u) {
      ...
      if (!x(a.objective, s) || !$(n, a.objective))
    ...
    function R(e, t, n, a, i, l, s) {
      ...
      var d = o("AdsAPICampaignRecordUtils").getPromotedObjectType(
        ...
        _ = r("qex")._("2585") === !0,
        f = {
          passes_ml_defaulting_rule: I(t),
          passes_heuristic_defaulting_rule: T(t),
          ml_result: m,
          heuristics_result: p,
          in_test_group: _,
        };
    ...
    function L(e, t, n, r) {
      if (!x(e, r) || !$(t, e)) return !1;
      var o = I(n);
      return (o && D(), o);
    }
    function E(e, t, n, o, a, i, l) {
      var s;
      if (!x(t, n) || !$(o, t)) return !1;
      var u = T(i),
    ...
    function k(e) {
      return e < 1 ? !0 : e >= 3 ? !1 : r("gkx")("20852") !== !0;
    }
    function I(e) {
    ...
    function F(e, t, n, a, i, l, s, u, c, d) {
      if (
        (l === void 0 && (l = null),
        s === void 0 && (s = !1),
    ...
    ((l.checkWebToIGDResponseRateGate = u),
      ...
      (l.enableWebToIGDDefaulting = M),
      (l.enableWebToIGDStickyDefaulting = w),
      (l.enableWebToWaDefaulting = F),
      (l.isWTXCreateAdTofuSource = W),
      (l.isWTXDefaultingFixesEnabled = q));
  },
  98,
);
