  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      ...
      m = r("immutable").Map([
        [
          "campaignGroup",
          o("AdsAdObjectLevelToPESelectors").getAllCachedSelectorMap.get(
            "campaign",
          ),
        ],
        [
        ...
        [
          "adgroup",
          o("AdsAdObjectLevelToPESelectors").getAllCachedSelectorMap.get("ad"),
        ],
      ]),
      p = r("immutable").Map([
      ...
      g = (function (t) {
        ...
        return (
          ...
          (a.$AdsPEFilteredDraftFragmentStore$p_20 = function (t, n, r) {
            var e,
              o = (e = p.get(r)) == null ? void 0 : e.getNewlyCreatedIDs();
            if (o == null || o.size === 0) return t;
            ...
            return t.concat(s).sort(function (e, t) {
              return l.getRaw(e.id).timeUpdated > l.getRaw(t.id).timeUpdated
                ? 1
                : -1;
            });
          }),
