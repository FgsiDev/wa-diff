  ...
  function (t, n, r, o, a, i, l) {
    ...
    function y(e, t, n, a, i, l, y, C, b, v, S, R) {
      var L,
        ...
        k = e,
        I =
          r("adsCampaignGetBudgetMode")(k.daily_budget, k.lifetime_budget) ==
          null,
        T = a.budget_strategy === "CAMPAIGN_FLEX_BUDGET";
      I &&
        a.bid_strategy &&
        a.pacing_type &&
        (k = d(k, a.bid_strategy, a.pacing_type));
      var D = t;
      if (
        t ===
        r("AdsAPIOptimizationGoals").MESSAGING_DEEP_CONVERSATION_AND_FOLLOW
      ) {
        D = r("AdsAPIOptimizationGoals").REPLIES;
        var x =
          k.destination_type === r("AdCampaignDestination").INSTAGRAM_DIRECT;
        k = r("AdsCampaignRecordAccessors").is_dc_follow_optimized.set(x, k);
      } else
        t !== r("AdsAPIOptimizationGoals").REPLIES &&
          (k = r("AdsCampaignRecordAccessors").is_dc_follow_optimized.set(
            !1,
            k,
          ));
      var $ = r("shouldPreserveMinROASSettingsOnOptimizationGoalChange")(
        k,
        T,
        D,
      );
      ((k = r("AdsCampaignRecordAccessors").optimization_goal.set(D, k)),
        !I &&
          !T &&
          !$ &&
          ((k = r("AdsCampaignRecordAccessors").is_autobid.set(!0, k)),
          (k = r("AdsCampaignRecordAccessors").is_average_price_pacing.set(
            !1,
            k,
          )),
          (k = r("AdsCampaignRecordAccessors").bid_strategy.set(
      ...
      var P = r("adsBillingEventGetDefaultDEPRECATED")(
        ...
        N = o("AdsThruPlayDurationUtils").getCpvBillingEventForGoal(
          k.optimization_goal,
        ),
        M =
          N != null &&
          ...
          r("gkx")("18778")
            ? N
            : P;
      k = r("AdsCampaignRecordAccessors").billing_event.set(M, k);
      var w = a.budget_strategy === "CAMPAIGN_FLEX_BUDGET";
      if (
        (w || (k = s(k, a.objective, i, n)),
        (k = p(
          k,
          a.objective,
          i,
        ...
        (k = h(k, a.buying_type)),
        k.bid_strategy === r("AdsAPIBidStrategies").LOWEST_COST_WITHOUT_CAP &&
          (k = _(k)),
        (k = o("AdsConversionWindowUtils").setDefaultClickConversionWindow(
          k,
          y,
        )),
        (k = o("AdsConversionWindowUtils").setDefaultViewConversionWindow(
          k,
          C,
        )),
        (k = o(
          "AdsConversionWindowUtils",
        ).setDefaultEngagedViewConversionWindow(k, b)),
        (k = f(k, a.objective, i, v, S, R, a.bid_strategy, n)),
        (k = g(k, a.objective, n, l)),
        (k = u(e, k)),
        a.objective === "OUTCOME_AWARENESS")
      ) {
        var A;
        k = o("AdsCampaignLiveVideoAdsUtils").maybeSetLiveVideoAdType(
          k,
          a == null || (A = a.promoted_object) == null
            ? void 0
            : A.live_video_destination,
        );
      }
      if (($ || (k = c(k)), T)) {
        var F,
          ...
          B =
            (F =
              (O = r("AdsCampaignRecordAccessors").adset_schedule.get(k)) ==
              null
                ? void 0
                : O.size) != null
              ? F
          ...
          var W,
            q =
              ...
              o(
                ...
                !1,
                "lifetime",
                o("AdsAPICampaignRecordUtils").getDestinationType(k),
                (W = k.promoted_object) == null ? void 0 : W.page_id,
                D,
              );
          q ||
            (k = o("AdsMutators").chain(
      ...
      if (
        !I &&
        !T &&
        D === r("AdsAPIOptimizationGoals").REACH &&
        a.objective === r("AdsAPIObjectives").OUTCOME_AWARENESS &&
        o(
          "AdsFrequencyControlGKUtils",
        ).isAccountEligibleForTargetFrequencyAuctionDefaulting()
      ) {
        var U = r("adsCampaignConvertUSDBudgetToCurrency")(
          n.currency,
          r("CampaignDefaultBudgetConfig").default_budget.lifetime,
        );
        ((k = r("AdsCampaignRecordAccessors").daily_budget.set(0, k)),
          (k = r("AdsCampaignRecordAccessors").lifetime_budget.set(U, k)),
          (k = o(
            "adsTargetFrequencyInAuctionMutationUtils",
          ).maybeDefaultScheduleForTargetFrequencyAuction(k, n.timezone_id)));
      }
      var V =
        (E = a.frequency_control_specs) == null || (E = E.toJS()) == null
          ? void 0
          : E.map(function (e) {
              return e.type;
            });
      return (
        r("isTargetFrequency")(V) &&
          (k = o(
            "adsTargetFrequencyInAuctionMutationUtils",
          ).maybeDefaultScheduleForTargetFrequencyAuction(k, n.timezone_id)),
        I || T ? m(k) : k
