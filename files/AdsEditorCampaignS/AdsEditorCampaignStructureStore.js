__d(
  ...
  function (t, n, r, o, a, i, l) {
          ...
          (n.reduce = function (t, n) {
            ...
            switch (
              ...
              case o("AdsAdgroupListBatchLoadedDataActionFlux").actionType: {
                ...
                if (r("isAdsSimpleCreateSurface")()) return E(t);
                if (a.tray) {
                  var i = v(t);
                  return ((i = i.set(_, x(a.section))), k(i, e));
                }
                return t;
              }
              ...
              case o("AdsCopyCopyCompletedDataActionFlux").actionType:
                return r("isAdsSimpleCreateSurface")() ? t : T(t, e);
              case o("AdsCreateCompletedActionFlux").actionType:
                return r("isAdsSimpleCreateSurface")() ? t : I(t, e);
              default:
                return t;
            }
          }),
    ...
    function b(e) {
      ...
      return (
        n && n.size === 0 && (n = y()),
        e.set(m, r("immutable").List(n)).set(p, D(e))
      );
    }
    function v(e) {
    ...
    function R(e) {
      var t = e.get(m);
      return e.set(m, r("immutable").List(t.concat(y()).toSet())).set(p, D(e));
    }
    function L(e, t) {
      var n = e;
      if (o("AdsApplicationUtils").isPowerEditor()) {
        if (r("isAdsSimpleCreateSurface")()) return E(e);
        var a = r("AdsPERouterHelper").getRouter().getParams(),
    ...
    function E(e) {
      var t,
        n,
        o,
        a = r("AdsPERouterHelper").getRouter().getParams(),
        i = a.selected_ad_ids,
        l = a.selected_adset_ids,
        s = a.selected_campaign_ids,
        u = (t = i == null ? void 0 : i.toArray()) != null ? t : [],
        c = (n = l == null ? void 0 : l.toArray()) != null ? n : [],
        d = (o = s == null ? void 0 : s.toArray()) != null ? o : [],
        f = d,
        g = "campaign";
      return (
        u.length > 0
          ? ((f = u), (g = "ad"))
          : c.length > 0 && ((f = c), (g = "ad_set")),
        e.set(m, r("immutable").List(d)).set(_, g).set(p, f)
      );
    }
    function k(e, t) {
      var n = function (t) {
