  ...
  function (t, n, r, o, a, i, l) {
    ...
    function g(e, t) {
      if (
        ...
        return !0;
      if (t != null) {
        var n = ["VALUE", "LIFETIME_VALUE"];
        return (r("gkx")("18062") && n.push("MARGIN"), n.includes(t));
      }
      return !0;
    }
    function h(e, t) {
    ...
    function C(t, n, a, i, l, s, c, d, m, p, y) {
      y === void 0 && (y = null);
      var C = h(n, a),
        b = _(t, c != null ? c : null),
        v = f(s),
      ...
      if (
        ...
        var k = o(
          "AdsEventsManagerSequencedConversionsCreationEligibilityUtils",
        ).isSetupEligibleForSequencedEventCreation(y, t, s);
    ...
    function v(e, t, n, r, o, a, i, l, s, u) {
      var c = b(r, e, t, n, o, a, i, l),
        ...
        v = C(h, d, m, s, u, p, y, g, _, f).length > 0;
      return !v;
    }
    ...
    ((l.IncrementalAttributionDisabledReason = e),
      ...
      (l.isAccountInIncrementalAttributionV2WithoutLogging = c),
      (l.getIncrementalAttributionAllowedPromotedObjectTypes = d),
      (l.getIncrementalAttributionAllowedPromotedObjectVariationTypes = p),
      (l.isValidPromotedObjectTypeForIncrementalAttribution = _),
      (l.isValidOptimizationGoalForIncrementalAttribution = f),
      (l.isValidBidForIncrementalAttribution = h),
      (l.getAllowedBidStrategiesForIncrementalAttribution = y),
      (l.getIncrementalAttributionDisabledReasons = C),
      (l.getAdsBulkUniformValueForIncrementalAttributionValidation = b),
      (l.validateForIANuxMessageOnCollapsedButton = v),
      (l.getAttributionWindowInDays = S),
      (l.getViewThroughWindowDays = L),
      (l.maybeApplyIncrementalAttribution = E));
  },
  98,
);
