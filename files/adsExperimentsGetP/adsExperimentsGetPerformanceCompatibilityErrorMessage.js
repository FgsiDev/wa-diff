__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    function u(e) {
      return s._(
        /*BTDS*/ "We're not able to turn on Advantage+ for {feature name} due to your performance goal.",
        [s._param("feature name", e)],
      );
    }
    function c(e) {
      return s._(
        /*BTDS*/ "We're not able to turn on {feature name} due to your performance goal.",
        [s._param("feature name", e)],
      );
    }
    l.default = e;
