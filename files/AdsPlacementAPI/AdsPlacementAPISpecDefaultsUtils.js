__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function s(e) {
      ...
      if (
        (c.length > 0 && (s[r("AdsAPITargetFields").WHATSAPP_POSITIONS] = c),
        r("gkx")("5403"))
      ) {
        var m = r("unsafeCast")(f("threads", l).toArray());
        m.length > 0 && (s[r("AdsAPITargetFields").THREADS_POSITIONS] = m);
      }
      return s;
    }
    function u(e) {
    ...
    function b(t, n) {
      return n.isHp1 === !0
        ? t.key === e && v(t, n)
        : t.isEnabled(n.capabilities, n.account) &&
            !t.getIneligibilityReason(n) &&
            (!t.isInactiveByDefault || !t.isInactiveByDefault(n));
    }
    function v(e, t) {
      return (
    ...
    ((l.getPlacementSpecWithDefaults = s),
