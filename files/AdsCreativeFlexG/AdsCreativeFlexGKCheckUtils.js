__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function x(e, t) {
      return (
        t === void 0 && (t = !0),
        !r("justknobx")._("3107") || !$(t) ? !1 : e !== "OPTED_OUT"
      );
    }
    function $(e) {
    ...
    ((l.isAccountEligibleForCreativeFlexRollout = e),
      ...
      (l.isAwarenessObjectiveEnabledForCreativeFlex = k),
      (l.isEligibleForCreativeFlexUnknownBucketFixEnhanced = I),
      (l.isEligibleForSADefaultOnRescue = T),
      (l.isAccountEligibleForPushModel = D),
      (l.isPushModelDefaultOn = x),
      (l.isPushModelStickyOptOut = P),
      (l.shouldSkipCreativeFlexSettingWriteOnDefaultOn = N),
      (l.shouldSkipCreativeFlexCagOriginWrite = M),
      (l.isExistingPostAdFlowEnabled = w),
      (l.isExistingPostAdDefaultOnEnabled = A),
      (l.getCreativeFlexOptOutStickyThreshold = F),
      (l.isRelatedMediaEnabledForExistingPostNoExposure = O),
      (l.isSuggestedPostHiddenAfterSelect = B),
      (l.isSuggestedPostRemovedAfterSelect = W),
      (l.isMultiPostRelatedMediaCoexistenceEnabled = q),
      (l.isEligibleForMultiMediaAltText = U));
  },
  98,
);
