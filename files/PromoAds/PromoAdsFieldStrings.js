__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    function x() {
      return s._(/*BTDS*/ "Select a promotion");
    }
    x.displayName = x.name + " [from " + i.id + "]";
    function $() {
      return s._(/*BTDS*/ "Show optimized promotions automatically");
    }
    $.displayName = $.name + " [from " + i.id + "]";
    function P() {
      return s._(/*BTDS*/ "Show optimized promotions when available");
    }
    P.displayName = P.name + " [from " + i.id + "]";
    function N() {
      return s._(/*BTDS*/ "Will show optimized promotions when available");
    }
    ...
    function M(e, t) {
      return o(
        ...
        ? o(
            "PromoAdsAdsManagerGatingAndExperimentUtils",
          ).isVanillaPromoAlwaysOnNewAutoModeContentEnabled()
          ? t && !e
            ? x()
            : P()
          : t && !e
    ...
    function O() {
      return s._(
        /*BTDS*/ "Promotions will appear on this ad once they are available.",
      );
    }
    O.displayName = O.name + " [from " + i.id + "]";
    function B() {
      return s._(
        /*BTDS*/ "Promotions will appear on this ad once you add them.",
      );
    }
    B.displayName = B.name + " [from " + i.id + "]";
    function W() {
          ...
          ? s._(
              ...
              [
                ...
                s._param(
                  ...
                  u.jsx(r("AdsLearnMore.react"), { cmsID: m, label: re() }),
                ),
              ],
            )
          : !e &&
    ...
    var le = s._(/*BTDS*/ "Link to privacy policy"),
      se = s._(/*BTDS*/ "http:\/\/www.example.com"),
      ue = s._(
    ...
    function _e(e) {
      return o(
        ...
        ? o(
          ...
          : s._(
              /*BTDS*/ "Meta will regularly detect your ad text, creative, website and manually created promo codes to find the one most likely to maximize conversions on your ads.",
            )
        : o(
              "PromoAdsAdCopyCodeGuidanceUXGatingUtils",
    ...
    var he = s._(/*BTDS*/ "Active ads affected by change"),
      ye = s._(
    ...
    var be = s._(/*BTDS*/ "Automatically show the best code"),
      ve = s._(/*BTDS*/ "No code available");
    function Se() {
      return s._(
    ...
    Re.displayName = Re.name + " [from " + i.id + "]";
    var Le = s._(/*BTDS*/ "Highlight your promotions"),
      Ee = s._(/*BTDS*/ "Add a code");
    function ke() {
      return o(
        "PromoAdsAdsManagerGatingAndExperimentUtils",
      ).isPromoAdsAutoSourcedOfferTransparencyEnabled()
      ...
      return o(
        ...
        ? s._(
            ...
            [
              ...
              s._param("Desc of individual preclick surfaces", De()),
              s._param(
    ...
    var xe = s._(/*BTDS*/ "Exclude code"),
      $e = s._(/*BTDS*/ "Select codes"),
      Pe = s._(/*BTDS*/ "Excluded codes"),
      Ne = s._(/*BTDS*/ "No results"),
      Me = s._(/*BTDS*/ "Code from ad text can\u2019t be excluded."),
      we = s._(
        /*BTDS*/ "Both an offer amount and privacy policy URL are required to collect emails.",
      ),
      Ae = s._(/*BTDS*/ "An offer amount is required to collect emails."),
      Fe = s._(/*BTDS*/ "A privacy policy URL is required to collect emails."),
      Oe = s._(/*BTDS*/ "A promo code is required to collect emails."),
      Be = s._(/*BTDS*/ "Change email sign-up offer"),
      We = s._(/*BTDS*/ "Change email sign-up offer"),
      qe = s._(
    ...
    var Ge = s._(/*BTDS*/ "Offer amount"),
      ze = s._(/*BTDS*/ "Save"),
      je = s._(/*BTDS*/ "Add"),
      Ke = s._(/*BTDS*/ "Add an offer"),
      Qe = s._(/*BTDS*/ "Edit email sign-up offers"),
      Xe = s._(/*BTDS*/ "Add an email sign-up offer"),
      Ye = s._(
    ...
    var Ze = s._(/*BTDS*/ "You can edit this offer later in Commerce Manager."),
      et = s._(
    ...
    var ot = s._(/*BTDS*/ "Edit"),
      at = s._(/*BTDS*/ "Offer amount");
    function it() {
      var e = o(
          "PromoAdsAdsManagerGatingAndExperimentUtils",
        ...
        t = o(
          ...
          ? u.jsxs(u.Fragment, {
              children: [
                ...
                u.jsx("br", {}),
                s._(
                  /*BTDS*/ "When a manually selected promotion is deleted or expires, no promotion will be displayed on your ad.",
                ),
                e ? null : u.jsx("br", {}),
              ],
            })
    ...
    var lt = s._(/*BTDS*/ "How promotions work"),
      st = s._(/*BTDS*/ "Opt in to promo codes"),
      ut = s._(
      ...
      mt = s._(/*BTDS*/ "Highlight your promotion on Instagram Stories"),
      pt = s._(/*BTDS*/ "Highlight your promotions on Instagram Stories"),
      _t = s._(/*BTDS*/ "Highlight your promotions on Facebook Reels"),
      ft = s._(
        /*BTDS*/ "We'll add an overlay to your ad creative using your ad text or highlighting available offers when it's likely to improve performance.",
      ),
      gt = s._(/*BTDS*/ "Highlight your promotions");
    function ht() {
    ...
    ((yt.displayName = yt.name + " [from " + i.id + "]"),
      ...
      (l.getPromoAdsAlwaysOnSelectPromotionLabel = x),
      (l.getPromoAdsAlwaysOnShowOptimizedPromotionsLabel = $),
      (l.getPromoAdsAlwaysOnShowOptimizedWhenAvailableLabel = P),
      (l.getPromoAdsAlwaysOnWillShowOptimizedPromotionsLabel = N),
      (l.getPromoAdsAlwaysOnAutoSourceOptionLabel = M),
      (l.getPromoAdsAlwaysOnAutoSourceDisplayLabel = w),
      (l.getPromoAdsAlwaysOnNotSeeingPromotionLabel = A),
      (l.getPromoAdsAlwaysOnNoPromotionsAvailableLabel = F),
      (l.getPromoAdsAlwaysOnPromotionsAppearWhenAvailableLabel = O),
      (l.getPromoAdsAlwaysOnPromotionsAppearWhenAddedLabel = B),
      (l.getPromoAdsNoAvailablePromotionsGuidanceTitle = W),
      (l.getPromoAdsNoAvailablePromotionsGuidanceBody = q),
      (l.getPromoAdsNoAvailablePromotionsGuidanceCTA = U),
      (l.getPromoAdsDetectedOffersEnabledToastTitle = V),
      (l.getPromoAdsDetectedOffersEnabledToastDescription = H),
      (l.getPromoAdsDetectedOffersEnabledToastCTA = G),
      (l.getPromoAdsDetectedOffersEnableErrorToastTitle = z),
      (l.PROMO_ADS_ALWAYS_ON_ADD_PROMOTION_BUTTON_LABEL = j),
      (l.getPromoAdsAlwaysOnDescriptionFbt = K),
      (l.getCodeNotAddedLabel = Q),
      (l.getNotSelectedLabel = X),
      (l.getOfferNotAddedLabel = Y),
      (l.getPromoCodesHelpText = J),
      (l.getEmailCaptureOptInLabel = Z),
      (l.getEmailCaptureHelpText = ee),
      (l.getPromoAdsEmailCaptureDescriptionFbt = te),
      (l.getPromoAdsWithPreClickDescriptionFbt = ne),
      (l.getPromoAdsEmailCaptureOfferAmountLabelFbt = ie),
      (l.PRIVACY_POLICY_LINK_INPUT_LABEL = le),
      (l.PRIVACY_POLICY_LINK_PLACEHOLDER = se),
      (l.PRIVACY_POLICY_LINK_ERROR_MESSAGE = ue),
      (l.PRIVACY_POLICY_HELP_TEXT = ce),
      (l.getEmailCaptureDescriptionText = me),
      (l.getNumberOfCodeSelectedLabel = pe),
      (l.getPromoAdsAutoSourcedCouponDescriptionFbt = _e),
      (l.getPromoAdsAutoSourceCouponDisabledMessageFbt = fe),
      (l.getEmailCaptureConfirmationFbt = ge),
      (l.EMAIL_CAPTURE_CONFIRMATION_PAGE_HEADER = he),
      (l.PROMO_ADS_MANUAL_COUPON_TOKENIZER_TOOLTIP = ye),
      (l.getPromoAdsAutoSourceCodeLabel = Ce),
      (l.PROMO_ADS_NO_CODE_AVAILABLE_LABEL = ve),
      (l.getPromoAdsNoCodeAvailableTooltipFbt = Se),
      (l.getPromoAdsCodeAvailableTooltipFbt = Re),
      (l.PROMO_ADS_MODULE_FIELD_HEADER = Le),
      (l.PROMO_ADS_ADD_A_CODE_LABEL = Ee),
      (l.getPromoAdsManualCodeSelectionLabel = ke),
      (l.getPromoAdsManualCodeDescription = Ie),
      (l.getPromoCodeHelpTextBodyFbt = Te),
      (l.PROMO_ADS_EDIT_EXCLUDED_CODE = xe),
      (l.PROMO_ADS_EXCLUDED_CODE_PLACEHOLDER = $e),
      (l.PROMO_ADS_EXCLUDED_CODES = Pe),
      (l.PROMO_ADS_NO_RESULTS = Ne),
      (l.PROMO_ADS_CANNOT_EDIT_AD_COPY_CODE_TOOLTIP = Me),
      ...
      (l.PROMO_ADS_EMAIL_CAPTURE_MODAL_CAN_NOT_SAVE_NO_VALID_PRIVACY_URL_TOOLTIP =
        Fe),
      (l.PROMO_ADS_EMAIL_CAPTURE_MODAL_CAN_NOT_SAVE_NO_PROMO_CODE_TOOLTIP = Oe),
      (l.PROMO_ADS_EMAIL_CAPTURE_UPDATE_OFFER_LABEL = Be),
      (l.PROMO_ADS_EMAIL_CAPTURE_UPDATE_OFFER_MODAL_HEADER = We),
      (l.PROMO_ADS_EMAIL_CAPTURE_UPDATE_OFFER_MODAL_DESCRIPTION = qe),
      (l.getEmailCaptureGenericCodeDescriptionText = He),
      (l.PROMO_ADS_EMAIL_CAPTURE_GENERIC_CODE_OFFER_AMOUNT_LABEL = Ge),
      (l.PROMO_ADS_EMAIL_CAPTURE_MODAL_PRIMARY_BUTTON_LABEL = ze),
      (l.PROMO_ADS_EMAIL_CAPTURE_SET_UP_MODAL_PRIMARY_BUTTON_LABEL = je),
      (l.PROMO_ADS_EMAIL_CAPTURE_SET_UP_OFFER_BUTTON_LABEL = Ke),
      (l.PROMO_ADS_EMAIL_CAPTURE_MODAL_EDIT_HEADER = Qe),
      (l.PROMO_ADS_EMAIL_CAPTURE_MODAL_ADD_AN_OFFER_HEADER = Xe),
      (l.getPromoAdsEmailCaptureModalAddOfferDescription = Je),
      (l.PROMO_ADS_EMAIL_CAPTURE_MODAL_EDIT_DESCRIPTION = Ze),
      (l.getPromoAdsEmailCaptureModalNoCmsDescription = tt),
      (l.getPromoAdsEmailCaptureModalGenericCodeDescription = rt),
      (l.PROMO_ADS_EMAIL_CAPTURE_EDIT_OFFER_TEXT = ot),
      (l.PROMO_ADS_EMAIL_CAPTURE_MODAL_OFFER_AMOUNT_INPUT = at),
      (l.getPromoAdsAlwaysOnHelpTextBodyFbt = it),
      (l.PROMO_ADS_HIGHLIGHT_HELP_TEXT_TITLE = lt),
      (l.PROMO_ADS_UPSELL_GUIDANCE_LABEL = st),
      (l.PROMO_ADS_UPSELL_GUIDANCE_HEADER = ut),
      (l.PROMO_ADS_UPSELL_GUIDANCE_BODY = ct),
      (l.PROMO_ADS_UPSELL_GUIDANCE_TOOLTIP = dt),
      (l.PROMO_ADS_PREVIEW_INSTAGRAM_STORIES_TOOLTIP_LABEL = mt),
      (l.PROMO_ADS_PREVIEW_INSTAGRAM_STORIES_TOOLTIP_LABEL_PLURAL = pt),
      (l.PROMO_ADS_PREVIEW_FB_REELS_TOOLTIP_LABEL = _t),
      (l.PROMO_ADS_PREVIEW_FB_REELS_TOOLTIP_BODY = ft),
      (l.PROMO_ADS_PREVIEW_PILL_LABEL = gt),
      (l.getPromoAdsPreviewIGStoriesLabelText = ht),
      (l.getPromoAdsPreviewPostClickLabelText = yt));
  },
  226,
);
