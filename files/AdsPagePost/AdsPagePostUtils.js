  ...
  function (t, n, r, o, a, i, l, s, u, c, d) {
    ...
    function y(e) {
      return e.filter(function (e) {
        return !f.includes(Number(e.key));
      });
    }
    function C(e) {
      return e.filter(function (e) {
        return Number(e.key) !== g;
      });
    }
    var b = function (t, n) {
      ...
      D = function (n, o, a, i, l) {
        ...
        if (o === r("AdsAPIObjectives").APP_INSTALLS || t || e(o, a))
          if (!ue(n))
            ...
            var s = o === r("AdsAPIObjectives").APP_INSTALLS && !Y(n),
              c = t && !J(n, i);
            (c || s) &&
              l.push(
                new (r("AdsError"))(
      ...
      M = function (t, n, o) {
        if (he(t) && n === r("AdsAPIObjectives").PRODUCT_CATALOG_SALES) {
    ...
    function O(e, t, n, r, o, a, i, l) {
      return (
        l === void 0 && (l = !1),
        h(e, t, n, r, o, a, null, !1, i, null, l).length === 0
      );
    }
    function B(e, t) {
      return !ce(t) && !pe(t);
      ...
      var o,
        a =
          (o = r("getByPath")(e, ["is_eligible_for_dark_post"])) != null
            ? o
            : !1;
      return !a || ae(e) ? !1 : le(n, t);
    }
    function ne(e) {
      return ie(e) ? !1 : r("gkx")("12335");
    }
    function re(e, t, n) {
      var o,
        a,
      ...
      return !i || !ee(n) || ae(e) ? !1 : ne(t);
    }
    function oe(e, t, n) {
      return !e || !ee(n) ? !1 : ne(t);
    }
    function ae(e) {
      var t;
      if (e == null) return !1;
    ...
    function se(e) {
      var t = _(o("AdsPagePostIDUtils").getPageIdFromPagePostId_BROKEN(e)),
        n = _(o("AdsPagePostIDUtils").getPostIdFromPagePostId_BROKEN(e));
    ...
    function de(e) {
      return ce(e) ? e.expiration_timestamp < Date.now() / 1e3 : !1;
    }
    function me(e) {
    ...
    function he(e) {
      return (
        _e(e) && ((e.object_id != null && e.object_id !== "") || ge(e) != null)
      );
    }
    function ye(e) {
    ...
    function Se(e) {
      return o("AdsPagePostIDUtils").isPagePostId_BROKEN(e)
        ? o("AdsPagePostIDUtils").getPostIdFromPagePostId_BROKEN(e)
        : e;
    }
    function Re(e, t) {
      e != null || d(0, 11831, e);
    ...
    function Ie(e) {
      var t = o("AdsPagePostIDUtils").normalizePagePostID(e);
    ...
    function Fe(e, t, n, a, i, l, s, u, c, d, m, p, _, f, g) {
      var h, y, C;
      ...
      var b = {
        ...
        v = o("BrandedContentAdsUtils").isSuggestedPost(n),
        S = We({
        ...
        E =
          ...
          o("AdsUseExistingPostModalConstants").NAV_TAB_TYPE.PARTNER_CONTENT
            ? "sponsor_boost"
            : "creator_boost";
      a && (E = i === "SPONSOR_BOOST" ? "sponsor_boost" : "creator_boost");
      var k = R + "[" + E + "] " + L,
        I = {
          eventName: m,
          data:
            ((C = {}),
            (C.is_enabled = e),
            (C.custom_event_type = t),
            (C.source = k),
            (C.message = JSON.stringify(b)),
            (C.prior_data = JSON.stringify(
              babelHelpers.extends({}, Object.fromEntries(S), {
                media_id: n == null ? void 0 : n.id,
                ccr_score:
                  (h =
                    n == null || (y = n.partnership_ads_identities) == null
                      ? void 0
                      : y.ccr_score) != null
                    ? h
                    : null,
                selected_partnership_content_tab: _,
                business_asset_page_id: r("isFalsey")(f) ? null : f,
                business_asset_instagram_user_id:
                  r("isTruthy")(g) && r("isFalsey")(f) ? g : null,
              }),
            )),
            (C.adgroup_id = d != null ? d.id : null),
            C),
          eventCategory: "user_action",
        };
      (v && m === "select_post_table_row" && Oe(I, p),
        p
          ? r("AdsInterfacesLogger").logOnce(I)
          : r("AdsInterfacesLogger").log(I));
    }
    function Oe(e, t) {
      t === void 0 && (t = !1);
    ...
    ((l.getFilterErrors = h),
      (l.getFilterSesameErrors = y),
      (l.filterInstagramPostIneligibilityErrors = C),
      (l.addFBReelWithCopyrightMusicErrors = b),
      (l.addFBReelWithCopyrightMusicSwapAgainErrors = v),
      (l.isVisible = O),
      (l.isVisibleForInstagram = B),
      (l.isVisibleInstagramOrganicPost = W),
      (l.isSesameEligible = te),
      (l.isLvaAppInstallSesameEligible = re),
      (l.isLvaAppInstallSesameEnabled = oe),
      (l.isPostFromPromodeProfile = ae),
      (l.isSesameExcludedDestination = ie),
      (l.getSesameEnabled = le),
      (l.isPostLoaded = se),
      (l.isVideoPost = _e),
      (l.isNativeVideoPost = he),
      (l.fetchAccessTokensForPageIDs = ye),
      (l.convertTypeToCreativeObjectType = Ce),
      (l.translatePostType = be),
      (l.generatePagePostId_BROKEN = ve),
      (l.maybeGetPostIdFromPagePostId = Se),
      (l.getPagePostURL_BROKEN = Re),
      (l.getProfilePlusPostURL = Le),
      (l.getPagePostURLForDCO = Ee),
      (l.getURLParamsForDCO = ke),
      (l.getPostIdBestGuess_BROKEN = Ie),
      (l.getPostSource = De),
      (l.getPostType = xe),
      (l.onConfirmLog = $e),
      (l.onClickLog = Pe),
      (l.onCreateNewPagePostClickLog = Ne),
      (l.onCreateNewPagePostConfirmLog = Me),
      (l.onPostsFetchedLog = we),
      (l.onSearchByEnterLog = Ae),
      (l.postTableRowLog = Fe),
      (l.onPostModalTabGroupClickLog = Be),
      (l.getPartnershipAdsPriorDataForLogging = We),
      (l.getSubSessionID = qe),
      (l.shouldShowExtraRowInTable = Ue),
      (l.isPostIGReel = Ve),
      (l.isPostIGStory = He),
      (l.isPostFBReel = Ge),
      (l.isIGPost = ze),
      (l.isFBLiveVideo = je),
      (l.getPageIdFromPagePostId_BROKEN =
        o("AdsPagePostIDUtils").getPageIdFromPagePostId_BROKEN),
      (l.getPostIdFromPagePostId_BROKEN =
        o("AdsPagePostIDUtils").getPostIdFromPagePostId_BROKEN),
      (l.isPagePostId_BROKEN = o("AdsPagePostIDUtils").isPagePostId_BROKEN));
  },
  226,
);
