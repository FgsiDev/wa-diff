        ...
        set: function (t, n) {
          ...
          return (
            typeof t == "string" &&
              ...
              r("qex")._("5048") === !0 && (e = r("immutable").List([t]))),
            r(
              "AdsAdgroupRecordAccessors",
      ...
      d = babelHelpers.extends({}, e.creative.asset_feed_spec.descriptions, {
        set: function (t, n) {
          ...
          if (
            ...
            r("justknobx")._("87") && r("qex")._("5048") === !0)
          ) {
            var o;
            e = r("immutable").List([
        ...
        r("AdsAdgroupRecordAccessors").creative.asset_feed_spec.titles,
        {
          set: function (t, n) {
            ...
            if (
              ...
              r("justknobx")._("207") && r("qex")._("5048") === !0)
            ) {
              var o;
              e = r("immutable").List([
                r("immutable").Map(((o = {}), (o.text = t), o)),
        ...
        r("AdsAdgroupRecordAccessors").creative.asset_feed_spec.bodies,
        {
          set: function (t, n) {
            ...
            if (
              ...
              r("justknobx")._("1391") && r("qex")._("5048") === !0)
            ) {
              var o;
              e = r("immutable").List([
                r("immutable").Map(((o = {}), (o.text = t), o)),
        ...
        r("AdsAdgroupRecordAccessors").creative.asset_feed_spec.link_urls,
        {
          set: function (t, n) {
            ...
            if (
              ...
              r("justknobx")._("1406") && r("qex")._("5048") === !0)
            ) {
              var o;
              e = r("immutable").List([
        ...
        r("AdsAdgroupRecordAccessors").creative.asset_feed_spec.images,
        {
          set: function (o, a) {
            ...
            if (
              ...
              r("justknobx")._("1537") && r("qex")._("5048") === !0)
            ) {
              var i;
              n =
                o === ""
