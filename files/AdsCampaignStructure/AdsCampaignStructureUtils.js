      ...
      if ((o === void 0 && (o = !1), o)) {
        var a = function (r) {
            var e = babelHelpers.extends({}, r, {
              isCollapsed: t.includes(r.id),
            });
            (i.push(e), !(n && e.isCollapsed) && r.children.forEach(a));
          },
          i = [];
        return (e.forEach(a), i);
      }
      function l(e) {
        var o = babelHelpers.extends({}, e, { isCollapsed: t.includes(e.id) });
        return n && o.isCollapsed
          ? [o]
          : [o].concat(r("concatArrays")(e.children.map(l)));
      }
      var s = e.map(function (e) {
        return l(e);
      });
      return r("concatArrays")(s);
    }
    function L(e) {
      var t = /^[1-9]\d*$/;
