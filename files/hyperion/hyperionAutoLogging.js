  ...
  function (t, n, r, o, a, i, l) {
    ...
    var ue = Object.freeze({
      ...
      ce = function (t) {
        ...
        if (typeof (e == null ? void 0 : e.postTask) == "function") {
          var n = e.postTask.bind(e);
          ce = function (t) {
            n(t, { priority: "user-blocking" }).catch(function () {});
          };
          ...
          ((o.port1.onmessage = function () {
            ...
            (ce = function (t) {
              (r.push(t), o.port2.postMessage(null));
            }));
        } else
          ce = function (t) {
            setTimeout(t, 0);
    ...
    var me = {
      ...
      pe = { capture: !0, passive: !0 },
      _e = { capture: !1, passive: !0 },
      fe = "data-interactable",
      ge = "interactableAncestor",
      he = function (t, n, r) {
        var e;
        function a(e, t, n, r) {
          var i, l, s, u;
          u = (m || (m = o("hyperionCore"))).getVirtualPropertyValue(e, ge);
          ...
          return ((p[n ? 0 : 1] = c), m.setVirtualPropertyValue(e, ge, u), c);
        }
        function i(e, t, n) {
          for (
            var r =
        ...
        return ((he = l ? a : i), he(t, n, r));
      };
    function ye(e, t, n) {
      return (
        n === void 0 && (n = !1),
        e instanceof Element ? he(e, t, n) : null
      );
    }
    function Ce(e, t) {
      var n = e["on" + t];
    ...
    function Re(e) {
      ...
      (t == null ? void 0 : t.active) === !0 &&
        (window.document.removeEventListener(e, t.captureHandler, pe),
        window.document.removeEventListener(e, t.bubbleHandler, _e),
        Se.delete(e),
        ve.set(e, babelHelpers.extends({}, t, { active: !1 })));
    }
    function Le(e, t) {
      var n,
        r = ve.get(e);
      (t != null && (Re(e), (r = babelHelpers.extends({}, t, { active: !1 }))),
        ((n = r) == null ? void 0 : n.active) === !1 &&
          (Ee(),
          window.document.addEventListener(e, r.captureHandler, pe),
          window.document.addEventListener(e, r.bubbleHandler, _e),
          Se.add(e),
          ve.set(e, babelHelpers.extends({}, r, { active: !0 }))));
    }
    var Ee = function () {
      var e,
        t = function (t) {
      ...
      function a(e, t) {
        be(e) || e.setAttribute(fe, n(t, e.getAttribute(fe)));
      }
      var i = new WeakMap();
      function l(e, t) {
        var n = i.get(e);
      ...
      var s =
        (e = o("hyperionGlobals").getFlags()) != null &&
        e.deferInteractabilityCheck
          ? l
          : a;
      ((p || (p = o("hyperionDOM"))).addEventListener.onBeforeCallObserverAdd(
        function (e, t) {
          Se.has(e) && this instanceof Element && s(this, e);
        },
      ),
        p.removeEventListener.onBeforeCallObserverAdd(function (e, t) {
          if (this instanceof Element) {
            var n;
            (n = i.get(this)) == null || n.delete(e);
            var o = r(e, this.getAttribute(fe));
            o ? this.setAttribute(fe, o) : this.removeAttribute(fe);
          }
        }),
        (f || (f = o("hyperionReact"))).onReactDOMElement.add(function (e, t) {
          if (t != null) {
            var r = t[fe];
    ...
    function $e(e) {
      var t;
      ((Te = e),
        (De = (t = Te.maxDepth) != null ? t : De),
        e.enableElementTextCache && (xe = new WeakMap()));
    }
    function Pe(e, t, n, r) {
      var o, a, i;
      return (
    ...
    function Ne(e, t, n, r, o) {
      var a = t.nodeValue;
      return a != null && a !== "" ? Pe({ text: a, source: n }, e, r, o) : null;
    }
    function Me(e) {
    ...
    function Ae(e, t, n, r) {
      ...
      return o != null && o !== "" ? Pe({ text: o, source: t }, e, n, r) : null;
    }
    function Fe(e, t, n, r) {
      for (
        ...
        i instanceof Element && i.nodeType === Node.ELEMENT_NODE
          ? Fe({ element: i, surface: a }, t, n, r)
          : i instanceof Text &&
            i.nodeType === Node.TEXT_NODE &&
            Ne({ element: o, surface: a }, i, t, n, r);
      return null;
    }
    var Oe =
      ...
      Be = /BUTTON|INPUT|METER|OUTPUT|PROGRESS|SELECT|TEXTAREA/;
    function We(e, t, n, r) {
      var o = e.element,
        a = e.surface,
        i = o.labels;
      if (i && i.length) {
        for (var l = 0, s = i.length; l < s; ++l) {
          var u = i[l];
          Fe({ element: u, surface: a }, t, n, r);
        }
        return n;
      }
      if (!Be.test(o.nodeName)) return null;
      if (o.parentElement instanceof HTMLLabelElement)
        return (Fe({ element: o.parentElement, surface: a }, t, n, r), n);
      if (o.id)
        try {
          var c = Oe(o.id),
    ...
    function qe(e, t, n, r, o) {
      var a, i, l, s;
      if ((r === void 0 && (r = 0), !(r > De))) {
        var u = { element: e, surface: t },
          c =
            (a =
              (i =
                (l =
                  (s = We(u, "label", n, o)) != null
                    ? s
                    : we(u, "aria-labelledby", n, o)) != null
                  ? l
                  : Ae(u, "aria-label", n, o)) != null
                ? i
                : Ae(u, "aria-description", n, o)) != null
              ? a
              : we(u, "aria-describedby", n, o);
        if (!c)
            ...
            (o != null &&
              ...
              (d instanceof HTMLElement && d.nodeType === Node.ELEMENT_NODE
                ...
                : d instanceof Text &&
                  ...
                  Ne({ element: e, surface: t }, d, "innerText", n, o));
      }
    }
    function Ue(e, t, n, r, o) {
      ...
      if (r) {
        var c,
          d = (c = xe) == null ? void 0 : c.get(e);
        if (d && d.surface === t) return d.result;
      }
      var m = [];
      if ((qe(e, t, m, 0, o), m.length === 0 && n)) {
        var p = ye(e.parentElement, n, !0);
        p && qe(p, t, m, 0, o);
      }
      var _ =
          (a =
      ...
      if (r) {
        var g;
        (g = xe) == null || g.set(e, { surface: t, result: f });
      }
      return f;
    }
    var Ve = Object.freeze({
        __proto__: null,
        SafeBubbleEventListenerOptions: _e,
        SafeCaptureEventListenerOptions: pe,
        UIEventNames: Se,
        cssEscape: Oe,
        disableUIEventHandlers: Re,
        enableUIEventHandlers: Le,
        extractCleanText: Ie,
        getElementTextEvent: Ue,
        getInteractable: ye,
        init: $e,
        isTrackedEvent: ke,
      }),
    ...
    function Ze() {
      var e, t;
      return (e = (t = Ye) == null ? void 0 : t.heartbeatInterval) != null
        ? e
        : Ge;
    }
    function et() {
    ...
    function tt(e) {
      if (!et()) {
        ...
        var t = e.channel,
          ...
          o = function (t) {
            ...
            if (!e) {
              var n = h();
              if (n - Ke >= Ge)
                if (((Qe = n), rt(He.REGAIN_PAGE_VISIBILITY), et())) {
                  var r;
                  (r = Xe) == null || r.delay(Ze());
                } else ot();
            }
          };
        document.addEventListener(je, o);
        var a;
        window.addEventListener(
          "focus",
          (a = function () {
            return rt(He.PAGE_FOCUS_GAINED);
          }),
          _e,
        );
        var i;
        (window.addEventListener(
          "blur",
          (i = function () {
            return rt(He.PAGE_FOCUS_LOST);
          }),
          _e,
        ),
          (Je = function () {
            (document.removeEventListener(je, o),
              window.removeEventListener("focus", a, _e),
              window.removeEventListener("blur", i, _e),
              t.removeListener("al_ui_event", r));
          }),
          rt(He.START),
          ot(),
          window.addEventListener("beforeunload", function () {
            (s || (s = n("Promise"))).resolve().then(nt);
          }));
      }
    }
    function nt() {
      et() &&
        (Xe != null && (Xe.cancel(), (Xe = null)),
        Je == null || Je(),
        rt(He.STOP));
    }
    function rt(e) {
    ...
    function ot() {
      Xe = new (o("hyperionTimedTrigger").TimedTrigger)(function () {
        et() && (rt(He.SCHEDULED), ot());
      }, Ze());
    }
    var at = "data-auto-logging-id";
    function it(e) {
      return e ? e.getAttribute(at) : null;
    }
    function lt(e) {
      var t = (c || (c = o("hyperionUtil"))).guid();
      return (e.setAttribute(at, t), t);
    }
    function st(e) {
      var t;
      return (t = it(e)) != null ? t : lt(e);
    }
    var ut;
    function ct(e) {
      var t,
      ...
      var a = e.maxAge || 10;
      ut = new (c || (c = o("hyperionUtil"))).CookiePersistentData(
      ...
      var s = new (o("hyperionTimedTrigger").TimedTrigger)(function () {
        ut.setValue({ id: ut.getValue().id, timestamp: h() });
      }, 500);
      function u() {
        s.restart();
      }
      (e.channel.addListener("al_ui_event_capture", u),
        ...
        e.channel.addListener("al_heartbeat_event", function (e) {
          e.heartbeatType === He.STOP && u();
        }));
    }
    function dt() {
      var e;
      return (e = ut) == null ? void 0 : e.getValue();
    }
    var mt = (function () {
        function e(e, t) {
          var n, r;
      ...
      gt = (function (e) {
        function t(t, n, r, o, a, i, l, s, u, c) {
          ...
          return (
            ...
            d.parent.addChild(d),
            (i != null && i.nonInteractive) || ft.set(n, d),
        ...
        return (
          ...
          (n.setUIEventMetadata = function (t) {
            if (t) {
              var e = this.getInheritedPropery(_t),
                n;
              (e
                ? ((n = Object.create(e)),
                ...
                : (n = t),
                this.setInheritedPropery(_t, n));
            }
          }),
          (n.getInheriteUIEventMetadata = function (t) {
            var e;
            return (e = this.getInheritedPropery(_t)) == null ? void 0 : e[t];
          }),
          ...
          (n.remove = function () {
            ...
            return (ft.delete(this.surface), !0);
          }),
          t
        );
      })(mt);
    gt.root = pt.singlton;
    var ht = gt.root,
      yt = new c.SafeGetterSetter("ALSurfaceContext");
    function Ct(e) {
      o("hyperionGlobals").assert(!yt.isSet(), "Already initilized");
      var t = (f || (f = o("hyperionReact"))).ReactModule.get();
      return (yt.set(t.createContext(ht)), yt.get());
    }
    function bt() {
      if (!yt.isSet()) return ht;
    ...
    function Et(e) {
      ...
      return l.createElement(yt.get().Provider, { value: a }, i);
    }
    var kt = function (t) {
      var e,
        n = t.surface,
      ...
      if (p) h = p.callFlowlet;
        ...
        ((h = new A.flowletCtor(n, (y = u.callFlowlet) != null ? y : A.root)),
          (h.data.surface = i),
          (p = new gt(n, a, u, i, h, m, _, g, l, s)));
      }
      ((_.original_call_flowlet = h.getFullName()),
        (_.surface_capability = St(m)),
        (p.metadata = _),
    ...
    if (
      ...
      var Ot = function () {
        return Ft(window.location.href, !0);
      };
      (window.addEventListener("hashchange", Ot),
        window.addEventListener("popstate", Ot),
        typeof window.navigation == "object" &&
          window.navigation.addEventListener("navigate", function (e) {
            Ft(window.location.href, !0);
          }),
        (p || (p = o("hyperionDOM"))).replaceState.onAfterCallMapperAdd(Ot),
        p.pushState.onAfterCallMapperAdd(Ot));
    }
    var Bt = 500;
    function Wt(e, t) {
      Le(e, t);
    ...
    function qt(e, t, n) {
      ...
      var l = null,
        s = null;
      if (i) {
        if (((l = ye(n.target, t)), l == null)) return null;
        s = st(l);
    ...
    function Vt() {
      var e;
      return (e = Ut) == null ? void 0 : e.data;
    }
    function Ht(e) {
      var t = e.uiEvents,
        n = e.channel,
        ...
        if (!ke(t)) {
          var f = function (s) {
            ...
            if (p) {
              ...
              var T = _ ? Ue(f, y, t, u) : Ue(null, null),
          ...
          (p || (p = o("hyperionDOM"))).stopPropagation.onBeforeCallObserverAdd(
            function () {
              Ut != null &&
                Ut.data.domEvent === this &&
                ((Ut.data.metadata.propagation_was_stopped = "true"),
                Ut.timedEmitter.run());
            },
          );
          var g = function (o) {
            var r = qt(e, t, o);
            if (r && (n.emit("al_ui_event_bubble", r), Ut != null)) {
              var a = Ut,
                i = a.data,
                l = a.timedEmitter;
              i.event === t &&
          ...
          Wt(t, { captureHandler: f, bubbleHandler: g });
        }
      });
      function a(e) {
        if (Ut != null) {
    ...
    function zt(e) {
      ...
      function _(e) {
        ...
        var c = d ? Ue(i, l, m, !0) : Ue(null, null),
          p = n.top();
        t.emit(
          "al_ui_event",
    ...
    function Jt() {
      ...
      if (typeof r == "string") {
        ...
        r instanceof Request
          ? (a = { body: r.body, method: r.method, url: r.url, uri: Qt(r.url) })
            ...
            return function (e) {
              return (
                ...
                s &&
                  ...
                  m.setVirtualPropertyValue(e, Yt, s),
                  e.then(function (n) {
                    var a,
                      i = (
                        m || (m = o("hyperionCore"))
                      ).getVirtualPropertyValue(e, Yt);
                    o("hyperionGlobals").assert(
                      i != null,
        ...
        (p || (p = o("hyperionDOM"))).open.onBeforeCallObserverAdd(
          function (e, t) {
            var n,
              a =
                typeof t == "string"
                  ? { method: e, url: t, uri: Qt(t) }
                  : { method: e, url: t.href, uri: t };
            (m || (m = o("hyperionCore"))).setVirtualPropertyValue(this, Yt, a);
    ...
    function sn(e) {
      ...
      function u(e, t, r, l) {
        (l === void 0 && (l = !0),
          l && e.observe(t),
          n &&
            ((m || (m = o("hyperionCore"))).setVirtualPropertyValue(t, an, e),
            m.setVirtualPropertyValue(t, ln, r)),
          a.set(t, r),
          i.set(r, t));
      }
      function c(e, t, r) {
        (e.unobserve(t),
          n &&
            ...
            m.setVirtualPropertyValue(t, ln, null)),
          a.delete(t, r),
          i.delete(r, t));
      }
      var d = null;
          ...
          for (var t of e)
            if (t.type === "childList") {
              var n = t.target,
                ...
                i = m.getVirtualPropertyValue(n, ln);
              if (!r || !i) return;
              if (
    ...
    var un = new (o("hyperionTestAndSet").TestAndSet)();
    function cn(e) {
      if (!un.testAndSet()) {
        var t = e.channel,
          n = A,
    ...
    var dn = new c.SafeGetterSetter("AutoLogging options");
    function mn(e) {
      var t;
      if (dn.isSet()) return !1;
      dn.set(e);
      var n = e.channel;
      if (e.plugins) {
      ...
      typeof o("hyperionGlobals").globalScope != "undefined" &&
        ...
        e.triggerFlowlet &&
          cn(babelHelpers.extends({ react: e.react }, a, e.triggerFlowlet)));
      var i = e.react;
      ...
      return (
        ...
        e.sessionFlowID && ct(babelHelpers.extends({}, a, e.sessionFlowID)),
        e.elementText && $e(e.elementText),
        e.flowletPublisher &&
          jt(babelHelpers.extends({}, a, e.flowletPublisher)),
        e.surfaceMutationPublisher &&
          nn(babelHelpers.extends({}, a, e.surfaceMutationPublisher)),
        e.surfaceVisibilityPublisher &&
          sn(babelHelpers.extends({}, a, e.surfaceVisibilityPublisher)),
        e.uiEventPublisher &&
          (Ht(babelHelpers.extends({}, a, e.uiEventPublisher)),
          Kt(babelHelpers.extends({}, a, e.uiEventPublisher)),
          zt(babelHelpers.extends({}, a, e.uiEventPublisher))),
        e.heartbeat && tt(babelHelpers.extends({}, a, e.heartbeat)),
        e.network && tn(babelHelpers.extends({}, a, e.network)),
        e.domSnapshotPublisher &&
          Gt(babelHelpers.extends({}, a, e.domSnapshotPublisher)),
        It(babelHelpers.extends({}, a, e.surface)),
        on({ react: e.react }),
        !0
      );
    }
    ...
    var _n = Object.freeze({ __proto__: null, getInitOptions: pn, init: mn });
    ((l.ALCustomEvent = O),
      (l.ALElementInfo = Q),
      ...
      (l.ALHeartbeatType = He),
      (l.ALInteractableDOMElement = Ve),
      (l.ALSurfaceChannel = vt),
      (l.ALSurfaceData = gt),
      (l.ALSurfaceUtils = ue),
      (l.AutoLogging = _n),
      (l.SURFACE_SEPARATOR = te),
      (l.Surface = kt),
      (l.getCurrentUIEventData = Vt),
      (l.getOrSetAutoLoggingID = st),
      (l.getSessionFlowID = dt),
      (l.useALSurfaceContext = bt));
  },
  98,
);
