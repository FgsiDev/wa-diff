__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    var e,
      u,
      c,
      d = (c = r("JSResourceForInteraction"))(
        "setE2eeIsMandatedForZenonLoggers",
      ).__setRef("ZenonCallsManager"),
      m = c("FallbackMQTTSignalingListener").__setRef("ZenonCallsManager"),
      p = c("IgSignalingListener").__setRef("ZenonCallsManager"),
      _ = c("ZenonDGWMWThriftMessageSender").__setRef("ZenonCallsManager"),
      f = c("ZenonDGWStreamManager").__setRef("ZenonCallsManager"),
      g = (function () {
        function t(e) {
          var t = this;
          ((this.$4 = new Map()),
            (this.$8 = null),
            (this.$10 = null),
            (this.$11 = new (r("ZenonRenderResolutionTracker"))()),
            (this.$12 = null),
            (this.$14 = new Map()),
            (this.$15 = new Map()));
          var a = e.getRelayEnvironment();
          ((this.$10 = new (r("ZenonSDKRateLimiter"))()),
            (this.$1 = new Map()),
            (this.$2 = e));
          var i = new (r("ZenonMessageSenderChain"))(
            [].concat(
              a && !o("ZenonDGWUtils").shouldUseDGW()
                ? [new (r("ZenonGraphQLMWThriftMessageSender"))(a)]
                : [],
            ),
          );
          if (
            (o("ZenonDGWUtils").shouldUseDGW() && r("qex")._("4380")
              ? (this.$13 = new (u || (u = n("Promise")))(function (e) {
              ...
              : o("ZenonDGWUtils").shouldUseDGW() && !r("qex")._("4380")
                ? ((this.$13 = (u || (u = n("Promise"))).resolve()),
                  ...
                  r("promiseDone")(_.load(), function (e) {
                    return i.addMessageSender(new e());
                  }))
                : ((this.$13 = (u || (u = n("Promise"))).resolve()),
                  i.addMessageSender(
            ...
            (this.$3 = new (r("ZenonSignalingClientManager"))(
              ...
              function (e, n, r) {
                return t.onInviteReceived(e, n, r);
              },
              i,
              e,
            )),
            ...
            var l = e.getEdgerayHostname();
            o("ZenonEdgerayDNSCache").warmUp(l != null ? l : void 0);
          }
        }
        var a = t.prototype;
        return (
            ...
            var e = n("asyncToGeneratorRuntime").asyncToGenerator(
              function* (e) {
                var t,
                  n = this,
                  a;
                if (e.ullcCallContext != null) return this.$17(e);
                ...
                (r("ZenonInfraActionsLogger").updateCachedValues({
                  ...
                  e.serverInfoData != null && this.$18(P, e.serverInfoData));
                var N = g == null,
                  M = !1;
                if (g != null) {
                  var w;
            ...
            var e = n("asyncToGeneratorRuntime").asyncToGenerator(
              function* (e) {
                ...
                L.setAiSessionCallingParams(
                  (t = e.aiSessionCallingParams) != null ? t : null,
                );
                ...
                if (!(!E || k == null)) {
                  ...
                  try {
                    ...
                    var O = babelHelpers.extends(
                        {},
                        (P = e.appMessages) != null ? P : {},
                      ),
                      B = e.initialSyncStates;
                    if (B != null) {
                    ...
                    (L.sendInvite(_, O), L.sendClientInfo(new Map()));
                  } catch (e) {
                    (r("FBLogger")("rtc_www").warn(
                      "ULLC join failed: %s",
          ...
          (a.addLocalTrack = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.addLocalTrack(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.removeLocalTrack = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.removeLocalTrack(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.muteTrack = function (t, r, o) {
            var e;
            return (
              o === void 0 && (o = !1),
              this.$21("muteTrack") &&
              (e = this.$20(t, function (e) {
                return e.muteTrack(r, o);
              })) != null
                ? e
                : (u || (u = n("Promise"))).resolve()
            );
          }),
          (a.unmuteTrack = function (t, r, o) {
            var e;
            return (
              o === void 0 && (o = !1),
              this.$21("unmuteTrack") &&
              (e = this.$20(t, function (e) {
                return e.unmuteTrack(r, o);
              })) != null
                ? e
                : (u || (u = n("Promise"))).resolve()
            );
          }),
          (a.stopLocalTrack = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.stopLocalTrack(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.initializeLogging = function (t, n) {
            ...
            if (
              m != null &&
              (i &&
                r("promiseDone")(d.load(), function (e) {
                  return e(m);
                }),
              r("ZenonInfraActionsLogger").updateCachedValues({
          ...
          (a.$22 = function (t) {
            (this.$7 != null &&
              t.log({ name: "signalingListenerLoadStart", timestamp: this.$7 }),
              this.$6 != null &&
                t.log({ name: "signalingListenerLoadEnd", timestamp: this.$6 }),
              this.$5 != null &&
                t.log({ name: "signalingJoinReady", timestamp: this.$5 }));
          }),
          (a.$23 = function () {
            var t = (e || (e = r("performanceNow")))();
            ((this.$5 = t),
              this.$4.forEach(function (e) {
                e.log({ name: "signalingJoinReady", timestamp: t });
              }));
          }),
          (a.initializeSignaling = function (n, a, i, l) {
            var t = this;
            ((this.$5 = null), (this.$6 = null));
            var s = (e || (e = r("performanceNow")))();
            return (
              (this.$7 = s),
              this.$4.forEach(function (e) {
                e.log({ name: "signalingListenerLoadStart", timestamp: s });
              }),
              this.$2.getSignalingListener().then(function (s) {
                var u = (e || (e = r("performanceNow")))();
                if (
                  ((t.$6 = u),
                  t.$4.forEach(function (e) {
                    e.log({ name: "signalingListenerLoadEnd", timestamp: u });
                  }),
                  s.subscribe(
                    function (e) {
                      return t.$3.receiveMessage(e);
                    },
                    function (e) {},
                  ),
                ...
                var d = t.$2
                  ...
                  .isEnabled();
                if (d)
                  (t.$23(), r("ZenonTransportEventEmitter").emitJoinReady());
                else if (a != null) {
                  var _ = t.$2
                    .getConfigManager()
                    .getZenonPlatformSupportConfig()
                    .getParentWindowConnectionTimeoutMs();
                  t.$8 = new (r("ZenonSignalingChildTransport"))({
                ...
                t.$8 &&
                  r("promiseDone")(t.$8.connect(), function (e) {
                    e.state === "join_ready"
                      ? (t.$23(),
          ...
          (a.endCall = function (t, a, i) {
            var e = o("ZenonDismissReason").endCallToDismissReason(a),
              l = this.$1.get(t),
              s = this.$14.get(t);
            if (s != null) {
              (s.sendDismiss("HANGUP_CALL", i), s.close(), this.$14.delete(t));
              var c = this.$15.get(t);
              if ((c != null && (c.close(), this.$15.delete(t)), l != null))
                return l.endUllc(e, i, !1);
            }
            if (l) return l.end(e, i);
            var d = this.$4.get(t);
            return (
              d != null
                ? d.log({
                ...
                : i !== o("ZenonConstants").DID_NOT_INITIATE &&
                  r("FBLogger")("rtc_www").warn(
          ...
          (a.ringParticipants = function (t, r, o) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.addParticipants(r, o);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.removeParticipants = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.removeParticipants(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.replaceLocalTrack = function (t, r, o, a) {
            var e;
            return (
              a === void 0 && (a = !1),
              (e = this.$20(t, function (e) {
                return e.replaceLocalTrack(r, o, a);
              })) != null
                ? e
                : (u || (u = n("Promise"))).resolve()
            );
          }),
          (a.forceEncodingEnabled = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.forceEncodingEnabled(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          ...
          (a.createDataMessageSubscription = function (t, r, o, a, i) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.createDataMessageSubscription(r, o, a, i);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.removeDataMessageSubscription = function (t, r, o) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.removeDataMessageSubscription(r, o);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.sendGenericDataMessage = function (t, r, a, i, l) {
            var e;
            return l !== o("ZenonTransportType").ZenonTransportType.SCTP &&
              !this.$21("dataMessage-" + r)
              ? (u || (u = n("Promise"))).resolve()
              : (e = this.$20(t, function (e) {
                    return e.sendGenericDataMessage(r, a, i, l);
                  })) != null
                ? e
                : (u || (u = n("Promise"))).resolve();
          }),
          (a.registerDataMessageService = function (t, r, o) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.registerDataMessageService(r, o);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          ...
          (a.subscribeToRemoteVideo = function (t, r, o) {
            var e = this.$1.get(t);
            return e != null
              ? e.subscribeToRemoteVideo(r, o)
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.updateStateSyncTopic = function (t, r, o) {
            var e;
            return this.$21("updateStateSync-" + r) &&
              (e = this.$20(t, function (e) {
                return e.updateStateSyncTopic(r, o);
              })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.unsubscribeFromStateSyncTopic = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.unsubscribeFromStateSyncTopic(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.approveParticipants = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.approveParticipants(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.denyParticipants = function (t, r) {
            var e;
            return (e = this.$20(t, function (e) {
              return e.denyParticipants(r);
            })) != null
              ? e
              : (u || (u = n("Promise"))).resolve();
          }),
          (a.getEncryptionKeysManagerState = function (t) {
            var e = this.$20(t, function (e) {
          ...
          (a.updateRenderedResolutionMap = function (t) {
            this.$11.setRenderResolutionMap(t);
          }),
          t
        );
      })();
