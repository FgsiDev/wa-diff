__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function Re(e) {
      return e ? r("qex")._("3482") === !0 : r("qex")._("3520") === !0;
    }
    function Le(e) {
    ...
    ((l.isWTMEligibleObjective = c),
      ...
      (l.enablePTWAMessageTemplateQE = Re),
      (l.enableWTXNonSalesMessageTemplate = Le),
      (l.enableWTDFollowUp = Ee),
      (l.enableWTDChatBuilderDefaultExpanded = ke),
      (l.isMessagingTemplateEnabledForWTD = Ie),
      (l.isPersonalOrSMBWANumber = Te),
      (l.isInWTMPFRExperiment = De),
      (l.enableWTMDefaultingExpansion = xe),
      (l.isAdAccountOptedOutOfWTMDefaulting = $e),
      (l.isAdAccountExcludedFromWTXDefaulting = Pe),
      (l.isWTXGenAIChatBuilderEnabled = Ne));
  },
  98,
);
