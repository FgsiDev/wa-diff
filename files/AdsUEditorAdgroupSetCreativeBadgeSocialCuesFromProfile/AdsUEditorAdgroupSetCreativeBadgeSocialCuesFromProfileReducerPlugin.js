__d(
  ...
  [
    ...
    "AdsUEditorAdgroupSetCreativeBadgeSocialCuesFromProfileDataActionFlux",
    "immutable",
  ],
            ...
            return o("AdsMutators").mutateEach(e, t.adgroupIDs, function (e) {
              return o("AdsMutators").chain(function (e) {
                var n,
                  ...
                  i = o("AdsCreativeBadgeEditingUtils").selectSocialCuesOption(
                    o(
                      "AdsCreativeBadgeGetUtils",
                    ).getBadgeItemSpecMapFromAssetFeed(a),
                    t.socialCuesFromProfileOption,
                    t.checkboxValue,
                  );
                return o(
                  "AdsUEditorAdgroupBadgesMutators",
