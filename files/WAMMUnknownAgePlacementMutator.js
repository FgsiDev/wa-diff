__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function e(e) {
      ...
      return o("WAMOUnknownAgeUtils").isAccountAgeSettingEligibleForUnknownAge(
        (t = n == null ? void 0 : n.account_id) != null ? t : "",
      )
    ...
    var s = {
        reduce: function (n, a) {
          ...
          var i = t.type,
            l =
              i === o("AdsCampaignPlacementAddDataActionFlux").actionType
                ? t.ids
                : t.campaignIDs;
          ...
          var s =
              ...
              i === o("AdsUEditorCampaignPlacementSetActionFlux").actionType,
            u =
              i === o("AdsCampaignPlacementAddDataActionFlux").actionType ||
              i === o("AdsUEditorCampaignPlacementSetActionFlux").actionType;
          return !s && !u
            ...
            : n.map(function (t, n) {
                ...
                return s && e(a)
                  ...
                  : u &&
                      !o(
                        "WAMOStatusAdsManagerUtils",
                      ).isOnlyMarketingMessagesSelectedFromCampaign(a) &&
                      !o(
                        "WAMOStatusAdsManagerUtils",
                      ).isWAMOStatusSelectedFromCampaign(a) &&
                      a.targeting.user_age_unknown != null
                    ? t.map(function (e) {
