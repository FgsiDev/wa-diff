__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function u(e, t, n) {
      var o = r("PECurrencyConfig").currency_map_for_render[e],
        a = o != null ? o.symbol : "",
        i = (o != null ? o.format : null) || "{symbol}{amount}";
      return (
        n === !0 &&
          a != e &&
          (i.indexOf("{symbol}") >= i.indexOf("{amount}")
            ? (i += " (" + e + ") ")
            : (i += " " + e)),
        i.replace("{symbol}", a).replace("{amount}", String(t))
      );
    }
    function c(t, n, o) {
