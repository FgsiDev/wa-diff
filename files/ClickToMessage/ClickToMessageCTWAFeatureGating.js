__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((l.isWAPendingNumbersLabelingEnabled = s),
      ...
      (l.isCTWAWabaAdsDataSharingToggleEnabled = N),
      (l.isAGMCTADefaultingEnabled = M),
      (l.isBSPContextInWANumberDropdownEnabled = w),
      (l.isCTWAAndromedaMigrationEnabled = A),
      (l.shouldShowWAUsernamesSMBNotice = F));
  },
  98,
);
