      ...
      c = (function () {
        ...
        return (
          (a.processEvent = function (a) {
            switch (a.name) {
              case "updateLogIdentifiers":
                ...
                break;
              case "signalingListenerLoadStart":
                this.$8 = a.timestamp;
                break;
              case "signalingListenerLoadEnd":
                this.$9 = a.timestamp;
                break;
              case "signalingJoinReady":
                this.$10 = a.timestamp;
                break;
              case "callJoinRequest": {
                ((this.$11 = a.hasOfferInRingRequest),
                ...
                (this.$18("signaling_listener_load_start", this.$8),
                  this.$18("signaling_listener_load_end", this.$9),
                  this.$18("signaling_join_ready", this.$10),
                  r("QPLUserFlow").addAnnotations(
                    r("qpl")._(398997251, "1544"),
                    {
                      bool: {
                        dgwMessageQueueEnabled: r("justknobx")._("4481"),
                      },
                    },
                    { instanceKey: +this.$3 },
                  ),
                  r("QPLUserFlow").addPoint(
                    r("qpl")._(398997251, "1544"),
                    "call_join_request",
                    { instanceKey: +this.$3, timestamp: this.$19() },
                  ),
                  r("QPLUserFlow").addAnnotations(
                    r("qpl")._(398997251, "1544"),
              ...
              case "setHasAnswerInJoinResponse":
                ((this.$13 = a.hasAnswerInJoinResponse), this.$20());
                break;
          ...
          (a.$18 = function (t, n) {
            ...
            e == null ||
              n == null ||
              r("QPLUserFlow").addPoint(r("qpl")._(398997251, "1544"), t, {
                instanceKey: +this.$3,
                timestamp: e + n,
              });
          }),
