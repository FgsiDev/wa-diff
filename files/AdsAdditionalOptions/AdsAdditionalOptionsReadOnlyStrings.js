__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    var e,
      u = s._(/*BTDS*/ "On"),
      c = s._(/*BTDS*/ "Off"),
      d = s._(/*BTDS*/ "None selected"),
      m = {
        liveIsExcluded: s._(/*BTDS*/ "{reelInstreamPlatformPosition} ads", [
          s._param(
            "reelInstreamPlatformPosition",
            (e = o(
              "FacebookReelsOverlayStoreUtils",
        ...
        isInstreamNonPartnerExcluded: s._(
          /*BTDS*/ "{reelInstreamPlatformPosition} ads",
          [
            s._param(
              "reelInstreamPlatformPosition",
              e.getReelInstreamPlatformPositionFbt(),
            ),
          ],
        ),
        isFBReelsNonPartnerExcluded: s._(
          /*BTDS*/ "{reelOverlayPlatformPosition}",
          [
            s._param(
              "reelOverlayPlatformPosition",
              e.getReelOverlayPlatformPositionFbt(),
            ),
          ],
        ),
        isFBInstreamReelsNonPartnerExcluded: s._(
          /*BTDS*/ "{reelInstreamPlatformPosition} and {reelOverlayPlatformPosition}",
          [
            s._param(
              "reelInstreamPlatformPosition",
              e.getReelInstreamPlatformPositionFbt(),
      ...
      p = {
        ...
        liveIsExcluded: s._(
          /*BTDS*/ "Exclude all live videos from {reelInstreamPlatformPosition} ads",
          [
            s._param(
              "reelInstreamPlatformPosition",
              e.getReelInstreamPlatformPositionFbt(),
        ...
        isFBReelsNonPartnerExcluded: s._(
          /*BTDS*/ "Exclude {reelOverlayPlatformPosition} from nonpartner-publishers",
          [
            s._param(
              "reelOverlayPlatformPosition",
              e.getReelOverlayPlatformPositionFbt(),
        ...
        isFBInstreamReelsNonPartnerExcluded: s._(
          /*BTDS*/ "Exclude {reelInstreamPlatformPosition} and {reelOverlayPlatformPosition} from nonpartner-publishers",
          [
            s._param(
              "reelInstreamPlatformPosition",
              e.getReelInstreamPlatformPositionFbt(),
      ...
      _ = s._(/*BTDS*/ "Minimum"),
      f = s._(/*BTDS*/ "Maximum"),
      g = s._(/*BTDS*/ "None added"),
      h = s._(/*BTDS*/ "Custom"),
      y = s._(/*BTDS*/ "Default"),
      C = s._(/*BTDS*/ "Loading error, please edit this field"),
      b = s._(/*BTDS*/ "Scale budget during specific time periods");
    function v(e) {
      switch (e) {
    ...
    ((l.TOGGLE_ON_LABEL = u),
      ...
      (l.NONE_SELECTED_LABEL = d),
      (l.BRAND_SAFETY_LABEL_CONTENT_TYPE_EXCLUSION_FOBRS = m),
      (l.BRAND_SAFETY_LABEL_MAP = p),
      (l.MIN_SPEND_LIMIT_FIELD_LABEL = _),
      (l.MAX_SPEND_LIMIT_FIELD_LABEL = f),
      (l.NONE_ADDED_LABEL = g),
      (l.CUSTOM_FREQUENCY_OPTION = h),
      (l.DEFAULT_FREQUENCY_OPTION = y),
      (l.LOADING_ERROR_MESSAGE = C),
      (l.TIME_SUGGESTION_ENABLED_LABEL = b),
      (l.getGenderStringFromSwitch = v),
      (l.getGenderString = S),
      (l.getDeviceTypeString = R),
      (l.getDeliveryTypeString = L),
      (l.getAdsSchedulingString = E),
      (l.getTimeZoneString = k),
      (l.getFrequencyCapString = I),
      (l.getCampaignGroupSpendLimitsString = T));
  },
  226,
);
