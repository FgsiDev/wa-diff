__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e = {
      ...
      p = {
        reduce: function (t) {
          return t === o("AdsRuleFlowTypes").DialogState.RECOMMENDED_RULES
            ? t
            : o("AdsRuleFlowTypes").DialogState.CREATING;
        },
      },
      _ = {
        reduce: function () {
      ...
      E = {
        reduce: function (t) {
          return t === o("AdsRuleFlowTypes").DialogState.RECOMMENDED_RULES
            ? t
            : t === o("AdsRuleFlowTypes").DialogState.CLOSED
              ? o("AdsRuleFlowTypes").DialogState.CLOSED
      ...
      P = {
        reduce: function () {
          return o("AdsRuleFlowTypes").DialogState.RECOMMENDED_RULES;
        },
      };
    ((l.AdsRuleDialogEditActionReducerPlugin = e),
      ...
      (l.AdsRuleDialogOpenRecommendedRulesReducerPlugin = P));
  },
  98,
);
