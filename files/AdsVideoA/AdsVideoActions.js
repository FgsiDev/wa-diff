  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    function _(e, t, n, a, l, s, u, c) {
      ...
      e
        ? r("AdsVideoUploadStartDataAction").dispatch(
            ...
            { line: "161", module: "AdsVideoActions.js", moduleID: i.id },
          )
        : !r("isStringNullOrEmpty")(t) &&
          ...
          r("AdsVideoUploadStartDataAction").dispatch(
            ...
            { line: "172", module: "AdsVideoActions.js", moduleID: i.id },
          );
    }
      ...
      if (
        (e.forEach(function (e, o) {
          return r("AdsVideoUploadStartDataAction").dispatch(
            ...
            { line: "198", module: "AdsVideoActions.js", moduleID: i.id },
          );
        }),
        a)
      ) {
        ...
        r("AdsAddToastCardAction").dispatch(
          ...
          { line: "259", module: "AdsVideoActions.js", moduleID: i.id },
        );
      }
    }
    function g(e, t, n, a) {
      ...
      (r("VideoAdsCreationSessionStateManager").startUploadSession(l, n),
        r("AdsVideoUploadStartDataAction").dispatch(
          ...
          { line: "277", module: "AdsVideoActions.js", moduleID: i.id },
        ));
    }
    function h(e, t, n) {
      ...
      (r("VideoAdsCreationSessionStateManager").startUploadSession(a, t),
        r("AdsVideoUploadStartDataAction").dispatch(
          ...
          { line: "296", module: "AdsVideoActions.js", moduleID: i.id },
        ));
    }
    function y(e, t, n, o) {
      (n || s(0, 2214),
        r("AdsVideoUploadStartDataAction").dispatch(
          ...
          { line: "310", module: "AdsVideoActions.js", moduleID: i.id },
        ));
    }
        ...
        ? (r("AdsInterfacesLogger").logOnce({
          ...
          a.forEach(function (a) {
            return r("AdsVideoUploadStartDataAction").dispatch(
              ...
              { line: "343", module: "AdsVideoActions.js", moduleID: i.id },
            );
          }))
        : (r("AdsInterfacesLogger").logOnce({
            eventName: "ig_start_upload_unuploaded_video_ui",
          ...
          r("AdsVideoUploadStartDataAction").dispatch(
            ...
            { line: "366", module: "AdsVideoActions.js", moduleID: i.id },
          ));
    }
    function b(e, t) {
      r("AdsInstagramVideoUploadStartDataAction").dispatch(
        { url: e, accountID: t },
        { line: "385", module: "AdsVideoActions.js", moduleID: i.id },
      );
    }
    function v(e) {
      r("AdsVideoUploadCancelDataAction").dispatch(
        typeof e == "string" ? { uploaderKey: e } : {},
        { line: "392", module: "AdsVideoActions.js", moduleID: i.id },
      );
    }
    function S(e) {
    ...
    function L() {
      r("AdsVideoUploadFinishDataAction").dispatch(
        {},
        { line: "411", module: "AdsVideoActions.js", moduleID: i.id },
      );
    }
    function E(e) {
      r("AdsVideoFilterDataAction").dispatch(
        { query: e },
        { line: "415", module: "AdsVideoActions.js", moduleID: i.id },
      );
    }
    function k(e) {
    ...
    function I(e) {
      r("AdsVideoSearchDataAction").dispatch(
        { query: e === "" ? void 0 : e },
        { line: "425", module: "AdsVideoActions.js", moduleID: i.id },
      );
    }
    ((l.openSelector = e),
