  ...
  function (t, n, r, o, a, i, l) {
    a.exports = {
      definitions: {
        ...
        configurable_audience_overlap_with_conv_action: l._(
          /*BTDS*/ "Attributed conversion events on the segment.",
        ),
        configurable_audience_overlap_with_conv_converters: l._(
          /*BTDS*/ "Distinct converting users on the segment. Reported on conversion date.",
        ),
        configurable_audience_overlap_with_conv_exposure_cost: l._(
          /*BTDS*/ "Delivered impression cost on the segment, in account currency, truncated at conversion for converters.",
        ),
        configurable_audience_overlap_with_conv_exposure_impressions: l._(
          /*BTDS*/ "Impression count on the segment, truncated at conversion for converters.",
        ),
        configurable_audience_overlap_with_conv_exposure_reach: l._(
          /*BTDS*/ "Distinct users exposed to the segment's cohort combination. For users who converted, only impressions before their first attributed conversion are counted.",
        ),
        configurable_placement_ptc_conversions: l._(
          /*BTDS*/ "Metrics for getting custom placement path to conversion -- conversions attributed to the people exposed to a placement path",
        ),
        configurable_placement_ptc_converters: l._(
          /*BTDS*/ "Metrics for getting custom placement path to conversion -- distinct people who converted after being exposed to a placement path",
        ),
        configurable_placement_ptc_reach: l._(
          /*BTDS*/ "Metrics for getting custom placement path to conversion -- distinct people exposed to a placement path, converters and non-converters alike",
        ),
        ...
        cost_per_result_temporal_delta_ratio: l._(
          /*BTDS*/ "The signed relative change in cost per result between the recent and preceding seven-day windows.",
        ),
        ...
        share_of_audience: l._(
          /*BTDS*/ "The percentage of your target audience that may see your ads, given your selected budget. This is based on the number of unique users reached divided by the total number of users in your audience that is online.",
        ),
