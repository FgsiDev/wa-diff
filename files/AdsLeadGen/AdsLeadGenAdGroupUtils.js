__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    var b = s._(
      ...
      $ = s._(/*BTDS*/ "Suggested conversion location");
    function P() {
      return s._(
        /*BTDS*/ "Send people to your website with a call button at the bottom of the screen to make it easy for them to call your business.",
      );
    ...
    function w(e, t) {
      ...
      var l = z(!1);
      return (
        (e === o("AdsAPIObjectives").OUTCOME_LEADS && V(t)) ||
        (!l &&
    ...
    ((l.FORM_EXTENSION_HELP_TEXT_TITLE = d),
      ...
      (l.WEBSITE_AND_CALLS_UPSELL_MFR_TABLE_SUGGESTED_CONVERSION_LOCATION = $),
      ...
      (l.isWebsiteAndCallsKeepOriginalAdgroupSource = U),
      (l.isLeadGenFormExtensionCampaign = V),
      (l.clearLeadGenFormId = H),
      (l.getLeadGenFormId = G),
      (l.shouldDisableFormExtension = z));
  },
  226,
);
