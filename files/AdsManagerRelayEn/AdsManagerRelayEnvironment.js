__d(
  ...
  [
    ...
    "AdsDataAtom",
    "AdsManagerRelayFieldLoggingContext",
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var h = n("cr:37580") != null ? n("cr:37580")() : null,
      y = o("RelayFieldLogger").create(),
      C = function (t) {
        o("AdsManagerRelayFieldLoggingContext").shouldSuppressRelayFieldLogging(
          t,
        ) || y(t);
      },
      b = o("AdsManagerRelayLogger").createAdsManagerRelayLogger(
    ...
    v.holdGC();
    var S = r("RelayModern").createEnvironment({
    ...
    (e || (e = r("AdsDataAtom"))).registerBatchingCallback(function (e) {
      if (R) {
        ...
        (r("ReactiveExecutorBatcher").executeBatchedUpdates(function () {
          n = v.batchLiveStateUpdatesWithoutNotify(e);
        }),
          n && t === v.getEpoch() && v.notify());
      } else
        v.batchLiveStateUpdates(function () {
