__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    var e = Object.freeze({
        ...
        newsfeed: {
          label: s._(/*BTDS*/ "Feed"),
          shortcuts: babelHelpers.extends(
            {
              commentStory: {
              ...
              scrollNext: {
                command: r("gkx")("17043")
                  ...
                  : { key: r("CometKeys").J },
                description: r("gkx")("17043")
                  ? s._(/*BTDS*/ "Jump to the next post")
                  : s._(/*BTDS*/ "Jump to the next post"),
                singleCharDescription: r("gkx")("17043")
            ...
            r("gkx")("17043")
              ? {
                  scrollToFeedEnd: {
                    command: r("UserAgent").isPlatform("Mac OS X")
                      ? { fn: !0, key: r("CometKeys").END }
                      : { command: !0, key: r("CometKeys").END },
                    description: s._(/*BTDS*/ "Move focus after Feed"),
                  },
                  scrollToFeedStart: {
                    command: r("UserAgent").isPlatform("Mac OS X")
                      ? { fn: !0, key: r("CometKeys").HOME }
