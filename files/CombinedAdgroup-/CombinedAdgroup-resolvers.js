__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((l.CombinedAdgroup = _),
      ...
      (l.delivery_status = Q),
      (l.demolink_hash = X),
      (l.display_sequence = Y),
      (l.effective_status = J),
      (l.engagement_audience = Z),
      (l.adgroup_id = ee),
      (l.creative_delivery_push = te),
      (l.creative_audience_pairing_persona = ne),
      (l.include_in_ad_study_cell_id = re),
      (l.include_in_ad_study_id = oe),
      (l.is_creative_flex_feature_aware = ae),
      (l.is_organic_ad_joint_optimized = ie),
      (l.is_eligible_for_message_editing = le),
      (l.last_updated_by_app_id = se),
      (l.lightweight_split_test = ue),
      (l.lightweight_split_test_options = ce),
      (l.manual_review_requested = de),
      (l.biz_ai_enabled_state = me),
      (l.meta_reward_adgroup_status = pe),
      (l.naming_template_custom_fields = _e),
      (l.priority = fe),
      (l.review_config = ge),
      (l.shops_ads_metadata_tags = he),
      (l.source_app_id = ye),
      (l.status = Ce),
      (l.targeting = be),
      (l.tracking_specs = ve),
      (l.view_tags = Se),
      (l.semantic_fields = Re),
      (l.placement = Le),
      (l.utils = Ee),
      (l.catalog_ui = ke));
  },
