__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    var e,
      u = e || (e = o("react")),
      c = Object.freeze({
        blockingUpsellSubtitleForSharer: s._(
          /*BTDS*/ "Log in or sign up to see more",
        ),
        ...
        getBlockingUpsellTitleForSharerReel: function (t) {
          return s._(/*BTDS*/ "Join {sharer first name} on Facebook", [
            s._param("sharer first name", t),
          ]);
        },
        ...
        getPopupTitleForSharerPost: function (t) {
          return s._(/*BTDS*/ "{sharer first name} shared this with you", [
            s._param("sharer first name", t),
          ]);
        },
        getPopupTitleForSharerReel: function (t) {
          return s._(/*BTDS*/ "{sharer first name} sent you a reel", [
            s._param("sharer first name", t),
          ]);
        },
        ...
        popupSubtitleForSharer: s._(
          /*BTDS*/ "Log in to join them on Facebook.",
        ),
