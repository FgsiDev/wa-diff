__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function d(e) {
      return {
        adAccountID: e,
        useAdAccountRef: r("getAdsAccountStoreNewSourceUseAdAccountRef")(),
      };
    }
    function m(e) {
      var t, n;
      return (t = e == null ? void 0 : e.ad_account) != null
        ? t
        : e == null || (n = e.ad_account_ref) == null
          ? void 0
          : n.ad_account;
    }
    var p =
      ...
      g = "loaded_ad_accounts",
      h = "AdAccount";
    function y() {
      return r("gkx")("15333");
    }
    function C(e) {
      var t = o("AdAccountIDConverter").toActID(e);
      return y() ? "AdsAccountStoreNewSource:placeholder:" + t : t;
    }
    var b = (function (e) {
      function t() {
        var t;
      ...
      return (
        ...
        (a.$AdsAccountStoreNewSource$p_2 = (function () {
          var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
            var t,
              ...
              i = r("amFetchPreloadedQuery")(this.__environment, p, d(a), {
              ...
              l = yield (c || (c = n("Promise"))).all([
                o("AdsAccountDataLoader").fetchGKs(this.removePrefixFromKey(a)),
                i,
              ]),
              s = l[0],
              u = l[1],
              _ = (t = m(u)) == null ? void 0 : t.id;
            s != null && _ != null
              ? (this.$AdsAccountStoreNewSource$p_1.set(
                  this.removePrefixFromKey(a),
                  s,
                ),
                o("AdsManagerAccountIDToNodeIDUtils").addAccountIDToNodeIDMap(
                  a,
                  _,
                ))
        ...
        (a.$AdsAccountStoreNewSource$p_3 = function (t, n) {
          ...
          r("amFetchPreloadedQuery")(this.__environment, p, d(a), {
            fetchPolicy: "store-or-network",
            networkCacheConfig: {
              metadata: {
                preloadingConfig: o(
        ...
        (a.__fetchQuery = function (t, n) {
          ...
          if (t.length !== 0) {
            var o = t.map(function (t) {
              ...
              a = o[0];
            (this.updateRecords(o.map(C), g, h),
              r("promiseDone")(
        ...
        (a.$AdsAccountStoreNewSource$p_4 = function (t) {
          var e = this.addPrefixToKey(t),
            n = C(e);
          o("RelayModern").commitLocalUpdate(this.__environment, function (e) {
            var t = e.get(n);
            (t == null ? void 0 : t.getType()) === h && e.delete(n);
          });
        }),
        (a.__getCached = function (t, n) {
          var e = this,
            a = t.map(function (t) {
              ...
              return (
                a == null &&
                  (r("FBLogger")("l4_reverse_interop", "missing_data_id").warn(
                  ...
                  value: r("readClientFragment")(
                    ...
                    function (t) {
                      return babelHelpers.extends(
                        ...
                        {
                          __gk_DO_NOT_USE: e.$AdsAccountStoreNewSource$p_1.get(
        ...
        (a.__deleteRelayCacheRecords = function (t) {
          var e = this;
          o("RelayModern").commitLocalUpdate(this.__environment, function (n) {
            var r,
              a = (r = n.getRoot().getLinkedRecords(g)) != null ? r : [];
            for (var i of t) {
              var l = e.addPrefixToKey(i),
                s = o("AdsManagerAccountIDToNodeIDUtils").getAccountNodeID(l);
              if (s != null) {
                var u = n.get(s);
                (u == null ? void 0 : u.getType()) === h &&
                  (u == null || u.setValue(void 0, "name"));
              }
            }
            n.getRoot().setLinkedRecords(a, g);
          });
        }),
        t
      );
