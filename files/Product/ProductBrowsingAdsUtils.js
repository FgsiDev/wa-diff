__d(
  ...
  function (t, n, r, o, a, i, l, s) {
        ...
        : m()
          ? p(t, n)
            ...
            : o("NativeCommerceExperienceAdsUtils")
                ...
                .CATALOG_NOT_SELECTED_NOR_FO_ENABLED
          : o("NativeCommerceExperienceAdsUtils")
              .NativeCommerceExperienceOptinIneligibilityReason
              .CATALOG_NOT_SELECTED;
    }
    var u = s._(
        /*BTDS*/ "To enable product browsing, select a catalog for your campaign.",
      ),
      c = s._(
        /*BTDS*/ "To enable product browsing, select a catalog for your campaign or turn on contextual links under Website highlights.",
      );
    function d(e) {
      return e == null
        ? null
    ...
    function m() {
      return r("gkx")("26764") === !0;
    }
    function p(e, t) {
      return (
        m() &&
        o("AdsAppExperiencesUtils").isFeaturedOfferingDataOptedInFromSpec(e, t)
      );
    }
    function _(e) {
      if (!m()) return !1;
      var t = e.adgroup,
        ...
        r = e.campaignGroup;
      return (
        o("AdsAppExperiencesUtils").isFeaturedOfferingDataOptedIn(t) &&
        o("AdsAutomaticFlowUtils").isStaticSingleImageOrVideoFormat(t) &&
        o(
          "AdsMetadataConnectedSourcesUtils",
        ).isEligibleForFeaturedOfferingByCampaignAndAdgroup(n, r, t)
      );
    }
    function f(e) {
      return (
    ...
    function C(e, t, n) {
      ...
      var s = (r = i.creative) == null ? void 0 : r.applink_treatment;
      if (s != null && s !== "web_only" && s !== "deeplink_with_web_fallback")
        return {
          isEligible: !1,
          reason:
            "applink_treatment_not_web_only_or_deeplink_with_web_fallback",
        };
      var u = ((a = i.creative) == null ? void 0 : a.product_set_id) != null;
      return u && s === "deeplink_with_web_fallback"
    ...
    function R(t, n, a, i, l, s, u) {
      var c,
        ...
        f =
          i != null &&
          a != null &&
          _({ adgroup: t, campaign: i, campaignGroup: a }),
        g = f ? null : e(p),
        h = n.isEligible && g == null,
        y = s.action_metadata.type.get(t),
        C = s.enroll_status.get(t);
      if (y === "MANUAL") return S(t, h, l, s);
      var v = h ? "OPT_IN" : "OPT_OUT",
        R = h ? "DEFAULT" : "DEFAULT_OFF";
      return (
        o("NativeCommerceExperienceLoggingUtils").logNCEEligibilityCheck(
          {
            adgroupId: t.id,
    ...
    function L(e, t, n, a, i) {
      ...
      var l = h()
        ? t != null && n != null
          ? C({ campaignGroup: t, campaign: n, adgroup: e }, i)
    ...
    function k(e, t, n, a, i) {
      ...
      var l =
        t != null && n != null
          ? C({ campaignGroup: t, campaign: n, adgroup: e }, i, !1)
          : { isEligible: !1, reason: "null_campaign_group_or_campaign" };
      return R(
        e,
        l,
    ...
    function I(e, t, n, r, a, i, l) {
      if (t)
        return o("AgenticCheckoutAdsUtils").clearAgenticCheckoutIfIneligible(
          v(e, n),
        );
      var s = L(e, r, a, i, l);
      return (
        (s = k(s, r, a, i, l)),
        o("AgenticCheckoutAdsUtils").clearAgenticCheckoutIfIneligible(s)
      );
    }
    ((l.getProductBrowsingDisabledReason = e),
      (l.getProductBrowsingDisabledMessage = d),
      (l.isContextualLinksProductSource = p),
      (l.isWebsiteHighlightsContextualLinksOptedIn = _),
      (l.isEligibleToSeeProductBrowsingToggle = C),
      (l.maybeUpdateProductBrowsingSpec = I));
  },
  226,
);
