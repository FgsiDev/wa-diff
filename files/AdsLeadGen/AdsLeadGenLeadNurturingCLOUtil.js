__d(
  ...
  function (t, n, r, o, a, i, l, s, u) {
    ...
    function d(e) {
      return (
        e === void 0 && (e = !0),
        e ? r("qex")._("4927") === !0 : r("qex")._("5910") === !0
      );
    }
    function m(e, t) {
    ...
    ((l.passCRMEnforceQEWithLogExposure = e),
      ...
      (l.canSelectLiquidityEvents = d),
      (l.getConnectCRMURL = m),
      (l.shouldDefaultCloAndMetaSource = p),
      (l.shouldDefaultMetaSource = _),
      (l.getDefaultedEventSource = f),
      (l.getDefaultedFollowUpEvent = g),
      (l.canSeeP2BCallCLO = h),
      (l.canSeeMessagingCLO = y),
      (l.getFormWithoutBusinessCallActionError = C),
      (l.getDataSourceNotSelectedError = b),
      (l.getMetaSourceNotSetUpError = v),
      (l.getLeadgenPlusWANotConnectedError = S),
      (l.getLeadgenPlusWAConsumerNumberError = R),
      (l.canSeeMetaSourceCLO = L),
      (l.isLeadgenPlusWhatsAppOptimization = E));
  },
  226,
);
