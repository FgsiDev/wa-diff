  ...
  function (t, n, r, o, a, i, l) {
    ...
    function f(e) {
      var t,
        ...
        r,
        o = g(e);
      if (o === "combobox") return null;
      if (o === "button") {
        var a = e.getAttribute("aria-pressed");
        return a !== null ? (a === "true" ? c.SELECTED : c.UNSELECTED) : null;
      }
      if (e instanceof HTMLInputElement)
        switch (o) {
          case "checkbox":
          ...
          case "file":
            return ((t = (n = e.files) == null ? void 0 : n.length) != null
              ? t
              : 0) > 0
              ? c.FILE_SELECTED
              : c.NO_FILE;
