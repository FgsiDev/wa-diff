      ...
      u = {
        INSTAGRAM_STORY: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isActiveInstagramPosition(t, "story");
          },
          ...
          maxWarningAspectRatio: (e = r("AdsInstagramMediaSpecs"))
            .MAX_STORY_ASPECT_RATIO,
          maxWarningLength:
            e.MAX_STORY_VIDEO_DURATION_IN_SEC_FOR_GREATER_THAN_TWO_MIN_VIDEOS,
        ...
        INSTAGRAM_STORY_CAROUSEL: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isOnlyActiveInstagramPosition(t, "story");
          },
          assetCustomizationPlacementChecker: function (t) {
          ...
          maxWarningLength:
            e.MAX_STORY_VIDEO_DURATION_IN_SEC_FOR_CAROUSEL_VIDEOS,
          minWarningWidth: e.MIN_MEDIA_WIDTH_LOW_RES,
          minWarningHeight: e.MIN_STORY_MEDIA_HEIGHT_LOW_RES,
          supportsCarousel: !0,
        },
        INSTAGRAM_REELS: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isOnlyActiveInstagramReelsPlacement(t);
          },
          assetCustomizationPlacementChecker: function (t) {
            return r("adsContainsAssetCustomizationPlacement")(t, {
              platform: "instagram",
        ...
        INSTAGRAM_STREAM: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isActiveInstagramPosition(t, "stream");
          },
          assetCustomizationPlacementChecker: function (t) {
            return r("adsContainsAssetCustomizationPlacement")(t, {
              platform: "instagram",
          ...
          maxWarningLength:
            e.MAX_STREAM_VIDEO_DURATION_IN_SEC_FOR_GREATER_THAN_TWO_MIN_ADS,
          minWarningWidth: e.MIN_MEDIA_WIDTH_LOW_RES,
        ...
        INSTAGRAM_PROFILE_FEED: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isActiveInstagramPosition(t, "profile_feed");
          },
          assetCustomizationPlacementChecker: function (t) {
            return r("adsContainsAssetCustomizationPlacement")(t, {
              platform: "instagram",
        ...
        INSTAGRAM_SEARCH_FEED: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isActiveInstagramPosition(t, "ig_search");
          },
          assetCustomizationPlacementChecker: function (t) {
            return r("adsContainsAssetCustomizationPlacement")(t, {
              platform: "instagram",
        ...
        INSTAGRAM_EXPLORE_HOME: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isActiveInstagramPosition(t, "explore_home");
          },
          assetCustomizationPlacementChecker: function (t) {
            return r("adsContainsAssetCustomizationPlacement")(t, {
              platform: "instagram",
          ...
          maxWarningLength:
            e.MAX_EXPLORE_HOME_VIDEO_DURATION_IN_SEC_FOR_GREATER_THAN_TWO_MIN_ADS,
          minWarningWidth: e.MIN_MEDIA_WIDTH_LOW_RES,
        ...
        INSTAGRAM_EXPLORE_HOME_CAROUSEL: {
          ...
          maxWarningAspectRatio: 1,
          maxWarningLength:
            e.MAX_EXPLORE_HOME_VIDEO_DURATION_IN_SEC_FOR_CAROUSEL_ADS,
          minWarningWidth: e.MIN_MEDIA_WIDTH_LOW_RES,
          minWarningHeight: e.MIN_MEDIA_WIDTH_LOW_RES,
          supportsCarousel: !0,
        },
        AUDIENCE_NETWORK_MOBILE_EXTERNAL: {
          ...
          placementChecker: function (t) {
            return (
              ...
              !o(
                "AdsPlacementAPISpecReaderUtils",
              ).isOnlyActivePublisherPlatform(t, "audience_network")
            );
          },
          assetCustomizationPlacementChecker: function (t) {
            var e = t.toArray().some(function (e) {
                return (
                  e.platform === "audience_network" &&
                  e.position === "instream_video"
                );
              }),
          ...
          minWarningLength: (s = r("AdsVideoConfig.experimental"))
            .audienceNetworkInStreamVideoMinDurationInSec,
        ...
        FACEBOOK_REELS: {
          ...
          placementChecker: function (t) {
            return o(
              "AdsPlacementAPISpecReaderUtils",
            ).isOnlyActiveFacebookReelsPlacement(t);
          },
          assetCustomizationPlacementChecker: function (t) {
            return r("adsContainsAssetCustomizationPlacement")(t, {
              platform: "facebook",
        ...
        THREADS_STREAM: {
          ...
          position: "stream",
          placementChecker: function (t) {
            return o("AdsPlacementAPISpecReaderUtils").isActiveThreadsPosition(
              t,
              "threads_stream",
            );
          },
          ...
          minWarningHeight: r("AdsThreadsMediaSpecs")
